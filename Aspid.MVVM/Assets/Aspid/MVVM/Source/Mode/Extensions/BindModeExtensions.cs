...
{
    /// <summary>
    /// Provides extension methods for <see cref="BindMode"/> providing mode classification checks and validation helpers.
    /// </summary>
    public static partial class BindModeExtensions
    {
        ...
        /// <returns><see langword="true"/> if the mode is <see cref="BindMode.OneWay"/> or <see cref="BindMode.OneTime"/>; otherwise, <see langword="false"/>.</returns>
        ...
        /// </summary>
        /// <param name="mode">The binding mode to check.</param>
        /// <returns><see langword="true"/> if the mode is <see cref="BindMode.TwoWay"/> or <see cref="BindMode.OneWayToSource"/>; otherwise, <see langword="false"/>.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
