...
- `IdRegistry` — `ScriptableObject`, связывающий тип-структуру со списком записей `(Id, Name)`. Property drawer отрисовывает выпадающий список, источником которого является этот реестр.
