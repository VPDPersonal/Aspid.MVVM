...
namespace Aspid.MVVM.StarterKit
{
    ...
    /// </summary>
    /// <example>
    /// Set the AudioSource loop property based on a boolean ViewModel value.
    /// <code>
    /// [View]
    /// public partial class ExampleView
    /// {
    ///     [SerializeField]
    ///     private AudioSourceLoopBinder _loop;
    /// }
    ///    
    /// [ViewModel]
    /// public partial class ExampleViewModel
    /// {
    ///     [Bind] public bool _loop;
    /// }
    /// </code>
    /// <code>
    /// [View]
    ...
    ///    
    ///     private AudioSourceLoopBinder Loop =>
    ///         new(_audioSource);
    /// }
    ///    
    /// [ViewModel]
    ...
    public class AudioSourceLoopBinder : TargetBoolBinder<AudioSource>
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="AudioSourceLoopBinder"/> targeting the specified <see cref="AudioSource"/>
        /// with inversion disabled.
        /// </summary>
        /// <param name="target">The <see cref="AudioSource"/> whose <see cref="AudioSource.loop"/> property is bound.</param>
