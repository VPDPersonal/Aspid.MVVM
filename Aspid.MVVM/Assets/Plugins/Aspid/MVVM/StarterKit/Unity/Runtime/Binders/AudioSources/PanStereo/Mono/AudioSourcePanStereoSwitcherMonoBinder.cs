...
{
    /// <summary>
    /// MonoBehaviour binder that switches the <see cref="AudioSource.panStereo"/> property on an <see cref="AudioSource"/>
    /// between two values based on a bound boolean ViewModel property. The value is clamped to the range [-1, 1].
    /// </summary>
