...
namespace Aspid.MVVM.StarterKit
{
    ...
    public class DelegateOneWayToSourceBinder<T> : Binder, IReverseBinder<T>
    {
        ...
        public DelegateOneWayToSourceBinder(
    ...
    /// <typeparam name="T">The type of the value reported to the ViewModel.</typeparam>
    public class DelegateOneWayToSourceBinder<TTarget, T> : Binder, IReverseBinder<T>
    {
