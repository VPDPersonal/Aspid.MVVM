...
namespace Aspid.MVVM.StarterKit
{
    ...
    public class DelegateTwoWayBinder<T> : Binder, IBinder<T>, IReverseBinder<T>
    {
    ...
    /// <typeparam name="T">The type of the value exchanged between View and ViewModel.</typeparam>
    public class DelegateTwoWayBinder<TTarget, T> : Binder, IBinder<T>, IReverseBinder<T>
    {
