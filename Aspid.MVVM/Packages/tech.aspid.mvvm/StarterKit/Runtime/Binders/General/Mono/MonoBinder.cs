...
{
    /// <summary>
    /// Abstract base <see cref="MonoBinder"/> that binds a single property through its accessors, applying an optional
    ...
    public abstract partial class MonoBinder<TProperty> : MonoBinder,
        IBinder<TProperty>,
