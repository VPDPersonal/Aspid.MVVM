...
namespace Aspid.MVVM.StarterKit
{
    ...
    public struct NumberReverseChannel
    {
        ...
        /// </summary>
        public bool HasIntegerListeners => IntValueChanged is not null || LongValueChanged is not null;

        /// <summary>
        /// Indicates whether <see cref="FloatValueChanged"/> or <see cref="DoubleValueChanged"/> has a subscriber.
        /// </summary>
        public bool HasFloatingPointListeners => FloatValueChanged is not null || DoubleValueChanged is not null;
