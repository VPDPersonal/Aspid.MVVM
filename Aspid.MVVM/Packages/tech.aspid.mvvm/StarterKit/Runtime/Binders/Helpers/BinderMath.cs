...
namespace Aspid.MVVM.StarterKit
{
    ...
    /// not bound to saturate at, so it is replaced and reported through <see cref="BinderLogger"/>. The
    ...
    public static class BinderMath
    {
        ...
        /// </remarks>
        /// <param name="binder">The sanitizing binder; a scene or asset object is pinged by default.</param>
        /// <param name="value">The extent to sanitize.</param>
        /// <param name="context">The object to ping instead of the binder.</param>
        ...
        /// on behalf of the specified binder type.
        /// </summary>
        /// <param name="binderType">The sanitizing binder's type.</param>
        /// <param name="value">The extent to sanitize.</param>
        /// <param name="context">The object to ping, when one is known.</param>
        /// <returns><paramref name="value"/> when it is finite and positive; otherwise, <c>0</c>.</returns>
        ...
        /// <summary>
        /// Reports <paramref name="value"/> when it is not finite, so the caller can skip to write.
        /// </summary>
        ...
        /// <summary>
        /// Raises anything below zero to <c>0</c> without reporting; the vector overloads report once per vector and sanitize each component through this.
        /// </summary>
