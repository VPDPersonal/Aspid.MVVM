...
{
    /// <summary>
    /// <see cref="ComponentMonoBinder{TComponent, TProperty}"/> that binds <see cref="Shadow.effectColor"/>.
    /// </summary>
    /// <remarks>
    /// <see cref="Outline"/> is a <see cref="Shadow"/>, so this binder targets either.
    /// </remarks>
