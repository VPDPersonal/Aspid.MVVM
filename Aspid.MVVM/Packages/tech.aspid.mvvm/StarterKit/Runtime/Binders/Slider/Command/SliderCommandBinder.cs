...
{
    /// <summary>
    /// <see cref="TargetBinder{TTarget}"/> that executes a command on <see cref="Slider.onValueChanged"/> with
    /// the slider value.
    /// </summary>
    /// <remarks>
        ...
        IBinder<IRelayCommand<double>>
    {
        ...
        /// How the command's CanExecute is reflected on the slider; not <see cref="InteractableMode.Custom"/>.
        /// </param>
        /// <param name="mode">The binding mode.</param>
        /// <exception cref="InvalidOperationException">
        /// <paramref name="mode"/> is <see cref="BindMode.TwoWay"/> or <see cref="BindMode.OneWayToSource"/>.
    ...
    /// <summary>
    /// <see cref="TargetBinder{TTarget}"/> that executes a command on <see cref="Slider.onValueChanged"/> with
    /// the slider value and <see cref="Param"/>.
    /// </summary>
    /// <remarks>
        ...
        IBinder<IRelayCommand<double, T>>
    {
        ...
        /// <param name="target">The slider to bind.</param>
        /// <param name="param">The extra parameter passed after the slider value.</param>
        /// <param name="mode">The binding mode.</param>
        /// <exception cref="InvalidOperationException">
        /// <paramref name="mode"/> is <see cref="BindMode.TwoWay"/> or <see cref="BindMode.OneWayToSource"/>.
        /// </exception>
    ...
    /// <summary>
    /// <see cref="TargetBinder{TTarget}"/> that executes a command on <see cref="Slider.onValueChanged"/> with
    /// the slider value and <see cref="Param1"/>, <see cref="Param2"/>.
    /// </summary>
    /// <remarks>
        ...
        IBinder<IRelayCommand<double, T1, T2>>
    {
        ...
        /// <param name="target">The slider to bind.</param>
        /// <param name="param1">The extra parameter passed after the slider value.</param>
        /// <param name="param2">The extra parameter passed after the slider value.</param>
        /// <param name="mode">The binding mode.</param>
        /// <exception cref="InvalidOperationException">
        /// <paramref name="mode"/> is <see cref="BindMode.TwoWay"/> or <see cref="BindMode.OneWayToSource"/>.
        /// </exception>
    ...
    /// <summary>
    /// <see cref="TargetBinder{TTarget}"/> that executes a command on <see cref="Slider.onValueChanged"/> with
    /// the slider value and <see cref="Param1"/>,
        ...
        IBinder<IRelayCommand<double, T1, T2, T3>>
    {
        ...
        /// <param name="param1">The extra parameter passed after the slider value.</param>
        /// <param name="param2">The extra parameter passed after the slider value.</param>
        /// <param name="param3">The extra parameter passed after the slider value.</param>
        /// <param name="mode">The binding mode.</param>
        /// <exception cref="InvalidOperationException">
        /// <paramref name="mode"/> is <see cref="BindMode.TwoWay"/> or <see cref="BindMode.OneWayToSource"/>.
        /// </exception>
