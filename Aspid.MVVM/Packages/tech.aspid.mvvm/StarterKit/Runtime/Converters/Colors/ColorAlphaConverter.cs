...
namespace Aspid.MVVM.StarterKit
{
    ...
    public sealed class ColorAlphaConverter : IConverter<Color, Color>
    {
        ...
        public Color Convert(Color value) =>
            Apply(this, value, _alpha, _mode);

        /// <summary>
        /// Applies an alpha to a color in the specified mode.
        /// </summary>
        /// <param name="reporter">The converter the mode was authored on, named in the report.</param>
        /// <param name="value">The color to adjust.</param>
        ...
        {
            reporter.LogError(
                problem: $"the mode {mode.Describe()} is not a declared {nameof(AlphaMode)}",
                consequence: "Leaving the alpha unchanged.");
