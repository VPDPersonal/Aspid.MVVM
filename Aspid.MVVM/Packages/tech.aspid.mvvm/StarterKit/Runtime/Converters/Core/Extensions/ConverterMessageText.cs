...
namespace Aspid.MVVM.StarterKit
{
    ...
    public static class ConverterMessageText
    {
        ...
        /// <summary>
        /// Writes a type name the way it is read in code — <c>BoolToValueConverter&lt;float&gt;</c>,
        /// not <c>BoolToValueConverter`1</c>.
        /// </summary>
        ...
        /// <summary>
        /// Writes what the converter needed and what it got instead:
