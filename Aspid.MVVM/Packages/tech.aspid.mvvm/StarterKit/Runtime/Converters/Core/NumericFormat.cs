...
namespace Aspid.MVVM.StarterKit
{
    ...
    internal static class NumericFormat
    {
        ...
        // Beyond the table the string is built, which is what an authored count past nine deserves:
        // a number is never read with ten decimals in a UI, and nothing has to be invalidated later.
