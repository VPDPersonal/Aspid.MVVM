...
namespace Aspid.MVVM.StarterKit
{
        ...
        ITwoWayConverter<double, double>
    {
        ...
        [Tooltip("Decibels at silence. Must be below Max Decibels, otherwise -80..0 dB is used.")]
        [SerializeField] private float _minDecibels = DefaultMinDecibels;

        [Tooltip("Decibels at full volume. Must be above Min Decibels, otherwise -80..0 dB is used.")]
        ...
        public AudioLinearDecibelConverter(
            float minDecibels,
            float maxDecibels = DefaultMaxDecibels,
            bool isInvert = false)
        {
        ...
        private (float Min, float Max) Range()
        {
            ...
            this.LogError(
                problem: $"silence at {_minDecibels} dB is not below full volume at {_maxDecibels} dB",
                consequence: $"Using {DefaultMinDecibels}..{DefaultMaxDecibels} dB instead.");
