...
namespace Aspid.MVVM.StarterKit
{
        ...
        IConverter<double, Vector2>
    {
        ...
        {
            // Vector2.== compares with a tolerance, so a very short direction reads as zero.
        ...
        Vector2 IConverter<float, Vector2>.Convert(float value) =>
            ConvertBack(value);

        float ITwoWayConverter<float, Vector2>.ConvertBack(Vector2 value) =>
            Convert(value);

        double IConverter<Vector2, double>.Convert(Vector2 value) =>
            Convert(value);
