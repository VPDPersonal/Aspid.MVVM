...
namespace Aspid.MVVM.StarterKit
{
        ...
        IConverter<Vector4, float>
    {
        ...
        [Tooltip("Direction Dot measures along. Keep it unit length to read a plain distance.")]
        ...
        {
            this.LogError(
                problem: $"the component {_component.Describe()} is not one {width} carries",
                consequence: "Returning zero.");
        ...
        {
            this.LogError(
                problem: $"the component {_component.Describe()} is not a declared {nameof(VectorComponent)}",
                consequence: "Returning zero.");
