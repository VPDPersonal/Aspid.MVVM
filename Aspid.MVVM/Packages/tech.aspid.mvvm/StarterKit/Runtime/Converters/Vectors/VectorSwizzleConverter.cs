...
namespace Aspid.MVVM.StarterKit
{
        ...
        IConverter<Vector2, Vector2>, IConverter<Vector3, Vector3>, IConverter<Vector4, Vector4>
    {
        ...
        /// <remarks>Default: identity, every component keeps its slot.</remarks>
        ...
        {
            this.LogError(
                problem: $"the {slot} slot reads {source.Describe()}, which a Vector{width} does not carry",
                consequence: $"Passing {slot} through unchanged.");
        ...
        {
            this.LogError(
                problem: $"the component {source.Describe()} is not a declared {nameof(Vector4Component)}",
                consequence: $"Passing {slot} through unchanged.");
