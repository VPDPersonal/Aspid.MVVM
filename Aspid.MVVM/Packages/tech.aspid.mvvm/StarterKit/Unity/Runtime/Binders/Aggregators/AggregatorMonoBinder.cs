...
namespace Aspid.MVVM.StarterKit
{
    ...
    public abstract class AggregatorMonoBinder<TInput, TResult> : MonoBehaviour
    {
        ...
        /// <summary>
        /// Forgets one input's reported value, so its unbinding does not make the aggregator combine a value that
        /// belonged to a previous binding, while other inputs stay reported.
        /// </summary>
        /// <param name="index">Index of the input that is no longer bound.</param>
