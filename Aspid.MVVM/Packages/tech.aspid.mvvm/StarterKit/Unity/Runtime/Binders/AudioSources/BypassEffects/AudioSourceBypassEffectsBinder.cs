...
{
    /// <summary>
    /// <see cref="TargetBinder{AudioSource, bool}"/> that sets the <see cref="AudioSource.bypassEffects"/> property.
    /// </summary>
    ...
    [Serializable]
    public class AudioSourceBypassEffectsBinder : TargetBinder<AudioSource, bool>
    {
        /// <inheritdoc/>
