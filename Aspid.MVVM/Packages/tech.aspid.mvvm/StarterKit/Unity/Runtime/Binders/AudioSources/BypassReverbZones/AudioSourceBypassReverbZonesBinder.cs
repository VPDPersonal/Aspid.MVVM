...
{
    /// <summary>
    /// <see cref="TargetBinder{AudioSource, bool}"/> that sets the <see cref="AudioSource.bypassReverbZones"/> property.
    /// </summary>
    ...
    [Serializable]
    public class AudioSourceBypassReverbZonesBinder : TargetBinder<AudioSource, bool>
    {
        /// <inheritdoc/>
