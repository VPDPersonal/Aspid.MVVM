...
{
    /// <summary>
    /// <see cref="EnumGroupMonoBinder{TElement,TValue}">EnumGroupMonoBinder&lt;AudioSource, float&gt;</see> that sets the <see cref="AudioSource.pitch"/>
    ...
    public sealed class AudioSourcePitchEnumGroupMonoBinder : EnumGroupMonoBinder<AudioSource, float>
    {
        ...
        protected override void SetValue(AudioSource element, float value) =>
            element.pitch = this.SafeClamp(value, -3, 3);
    }
}