...
{
    /// <summary>
    /// <see cref="EnumMonoBinder{TComponent,TValue}">EnumMonoBinder&lt;AudioSource, float&gt;</see> that sets the <see cref="AudioSource.spatialBlend"/>
    ...
    public sealed class AudioSourceSpatialBlendEnumMonoBinder : EnumMonoBinder<AudioSource, float>
    {
        ...
        protected override void SetValue(float value) =>
            CachedComponent.spatialBlend = this.SafeClamp(value, 0, 1f);
    }
}