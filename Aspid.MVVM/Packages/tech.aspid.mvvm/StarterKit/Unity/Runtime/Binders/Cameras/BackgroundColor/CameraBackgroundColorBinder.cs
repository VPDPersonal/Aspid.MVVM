...
{
    /// <summary>
    /// <see cref="TargetBinder{Camera, Color}"/> that binds <see cref="Camera.backgroundColor"/>.
    /// </summary>
    /// <remarks>Only visible when the camera's clear flags are set to solid color.</remarks>
    [Serializable]
    public class CameraBackgroundColorBinder : TargetBinder<Camera, Color>, IColorBinder
    {
        /// <inheritdoc/>
