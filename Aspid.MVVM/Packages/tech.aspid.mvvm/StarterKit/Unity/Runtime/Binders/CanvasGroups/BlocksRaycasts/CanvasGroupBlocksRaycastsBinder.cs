...
{
    /// <summary>
    /// <see cref="TargetBinder{CanvasGroup, bool}"/> that sets the <see cref="CanvasGroup.blocksRaycasts"/> property.
    /// </summary>
    /// <include file="XmlExampleDoc-CanvasGroup-BlocksRaycasts-1.1.0.xml" path="doc//member[@name='CanvasGroupBlocksRaycastsBinder']/*" />
    [Serializable]
    public class CanvasGroupBlocksRaycastsBinder : TargetBinder<CanvasGroup, bool>
    {
        /// <inheritdoc/>
