...
namespace Aspid.MVVM.StarterKit
{
    ...
    /// </summary>
    /// <remarks>
    /// The collection interfaces are covariant, so a list of any class is accepted here without a subclass per element
    /// type. A collection of a value type, such as a list of <see langword="int"/>, is not: covariance does not apply
    /// to those, and a project that binds one writes the one-line subclass over its own element type.
    /// </remarks>
