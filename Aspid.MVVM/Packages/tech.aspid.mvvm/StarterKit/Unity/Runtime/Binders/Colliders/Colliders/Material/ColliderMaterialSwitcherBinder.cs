...
{
    /// <summary>
    /// <see cref="SwitcherBinder{T1, T2, T3}">SwitcherBinder&lt;Collider, PhysicsMaterial, IConverter&lt;PhysicsMaterial, PhysicsMaterial&gt;&gt;</see> that switches the <see cref="Collider.material"/>
