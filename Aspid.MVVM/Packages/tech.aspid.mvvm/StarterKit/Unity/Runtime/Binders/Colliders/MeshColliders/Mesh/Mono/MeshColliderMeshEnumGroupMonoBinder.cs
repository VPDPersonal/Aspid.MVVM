...
{
    /// <summary>
    /// <see cref="EnumGroupMonoBinderWithConverter{T1, T2}">EnumGroupMonoBinderWithConverter&lt;MeshCollider, Mesh&gt;</see> that sets the <see cref="MeshCollider.sharedMesh"/>
    ...
    public sealed class MeshColliderMeshEnumGroupMonoBinder : EnumGroupMonoBinderWithConverter<MeshCollider, Mesh>
    {
        /// <inheritdoc/>
