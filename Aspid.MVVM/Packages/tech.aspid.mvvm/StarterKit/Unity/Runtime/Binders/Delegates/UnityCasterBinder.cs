...
namespace Aspid.MVVM.StarterKit
{
    ...
    [System.Obsolete("Use the CasterBinder instead: it takes a plain Action, which a UnityAction converts to implicitly. The Unity-flavoured copies exist only for that conversion and will be removed in the next major version.")]
    public class UnityCasterBinder<TFrom, TTo> : Binder, IBinder<TFrom>
    {
    ...
    /// </remarks>
    [System.Obsolete("Use the CasterBinder instead: it takes a plain Action, which a UnityAction converts to implicitly. The Unity-flavoured copies exist only for that conversion and will be removed in the next major version.")]
    public class UnityCasterBinder<TTarget, TFrom, TTo> : Binder, IBinder<TFrom>
    {
