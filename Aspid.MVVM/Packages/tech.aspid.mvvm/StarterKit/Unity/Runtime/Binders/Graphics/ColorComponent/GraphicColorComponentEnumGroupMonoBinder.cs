...
{
    /// <summary>
    /// <see cref="EnumGroupMonoBinder{TElement,TValue}">EnumGroupMonoBinder&lt;Graphic, float&gt;</see> that sets a single <see cref="ColorComponent"/> channel
    ...
    public sealed class GraphicColorComponentEnumGroupMonoBinder : EnumGroupMonoBinder<Graphic, float>
    {
