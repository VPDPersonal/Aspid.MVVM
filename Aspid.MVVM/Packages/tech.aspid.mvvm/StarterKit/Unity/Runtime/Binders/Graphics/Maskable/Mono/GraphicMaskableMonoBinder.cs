...
{
    /// <summary>
    /// <see cref="ComponentBoolMonoBinder{MaskableGraphic}"/> that binds the <see cref="MaskableGraphic.maskable"/> property.
    /// </summary>
    /// <remarks>
    ...
    public class GraphicMaskableMonoBinder : ComponentBoolMonoBinder<MaskableGraphic>
    {
        /// <inheritdoc/>
