...
namespace Aspid.MVVM.StarterKit
{
    ...
    public class InputFieldLineTypeBinder : TargetBinder<TMP_InputField, TMP_InputField.LineType>
    {
        ...
        public InputFieldLineTypeBinder(TMP_InputField target, IConverter<TMP_InputField.LineType, TMP_InputField.LineType> converter = null, BindMode mode = BindMode.OneWay) 
