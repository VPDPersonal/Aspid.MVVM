...
{
    /// <summary>
    /// <see cref="TargetBinder{LocalizeStringEvent, string}"/> that sets the TableEntryReference
    ...
    [Serializable]
    public class LocalizeStringEventEntryBinder : TargetBinder<LocalizeStringEvent, string>
    {
        /// <inheritdoc/>
        protected sealed override string? Property
        {
            get => Target.StringReference.TableEntryReference.ToKeyName(this, Target);
