...
{
    /// <summary>
    /// Abstract base <see cref="ComponentMonoBinder{T1, T2, T3}">ComponentMonoBinder&lt;TComponent, Color, IConverter&lt;Color, Color&gt;&gt;</see> that binds a <see cref="Color"/> property and implements <see cref="IColorBinder"/>.
    /// </summary>
