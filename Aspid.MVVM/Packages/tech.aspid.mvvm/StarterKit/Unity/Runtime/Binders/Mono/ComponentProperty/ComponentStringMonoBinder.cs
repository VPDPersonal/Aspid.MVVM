...
{
    /// <summary>
    /// Abstract base <see cref="ComponentMonoBinder{T1, T2, T3}">ComponentMonoBinder&lt;TComponent, string, IConverter&lt;string, string&gt;&gt;</see> that binds a <see langword="string"/> property.
    /// </summary>
