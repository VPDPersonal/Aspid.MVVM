...
namespace Aspid.MVVM.StarterKit
{
    ...
    /// </summary>
    /// <remarks>
    /// A binder the ViewModel calls rather than one that receives values. Once bound, it exposes the operation as
    /// a plain <see cref="Action"/> or as an <see cref="IRelayCommand"/> whose <see cref="IRelayCommand.CanExecute()"/>
    /// mirrors <see cref="CanExecute"/>.
    /// </remarks>
