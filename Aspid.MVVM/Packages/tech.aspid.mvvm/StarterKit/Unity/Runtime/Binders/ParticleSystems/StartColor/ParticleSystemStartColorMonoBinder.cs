...
namespace Aspid.MVVM.StarterKit
{
    ...
    /// </summary>
    /// <remarks>
    /// Only particles emitted after the write take the new color; particles already alive keep theirs. The write
    /// collapses any gradient- or range-authored start color to a single value.
    /// </remarks>
