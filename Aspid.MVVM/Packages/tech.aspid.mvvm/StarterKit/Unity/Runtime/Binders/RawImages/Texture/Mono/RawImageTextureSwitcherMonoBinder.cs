...
{
    /// <summary>
    /// <see cref="SwitcherMonoBinderWithConverter{T1, T2}"/> that switches the <see cref="RawImage.texture"/>
    ...
    public sealed class RawImageTextureSwitcherMonoBinder : SwitcherMonoBinderWithConverter<RawImage, Texture>
    {
