...
{
    /// <summary>
    /// <see cref="EnumGroupMonoBinder{ScrollRect, Single}"/> that sets <see cref="ScrollRect.horizontalNormalizedPosition"/>
    ...
    public sealed class ScrollRectHorizontalNormalizedPositionEnumGroupMonoBinder : EnumGroupMonoBinder<ScrollRect, float>
    {
        /// <summary>
