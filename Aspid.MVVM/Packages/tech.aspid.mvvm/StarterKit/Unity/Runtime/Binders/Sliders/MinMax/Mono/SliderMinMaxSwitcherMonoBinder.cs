...
{
    /// <summary>
    /// <see cref="SwitcherMonoBinder{T1, T2}"/> that switches <see cref="Slider.minValue"/> and <see cref="Slider.maxValue"/> between two ranges based on the bound boolean ViewModel value.
    /// </summary>
