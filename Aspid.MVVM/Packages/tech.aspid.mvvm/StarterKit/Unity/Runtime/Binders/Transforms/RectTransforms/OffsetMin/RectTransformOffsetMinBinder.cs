...
{
    /// <summary>
    /// <see cref="TargetVector2Binder{RectTransform}"/> that binds <see cref="RectTransform.offsetMin"/>.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [Serializable]
    public class RectTransformOffsetMinBinder : TargetVector2Binder<RectTransform>
    {
        /// <inheritdoc/>
