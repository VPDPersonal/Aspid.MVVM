...
{
    /// <summary>
    /// <see cref="EnumGroupMonoBinder{Transform, Vector3}"/> that sets the <see cref="Transform.eulerAngles"/> or
    /// <see cref="Transform.localEulerAngles"/> on each element in the group based on the bound enum ViewModel value.
    /// </summary>
    ...
    public sealed class TransformEulerAnglesEnumGroupMonoBinder : EnumGroupMonoBinder<Transform, Vector3>
    {
        ...
        /// Sets the euler angles of the element in the configured <see cref="Space"/>.
        /// </summary>
