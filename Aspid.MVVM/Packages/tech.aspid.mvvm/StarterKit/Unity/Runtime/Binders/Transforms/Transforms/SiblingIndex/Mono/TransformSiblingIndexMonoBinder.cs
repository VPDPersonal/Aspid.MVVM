...
namespace Aspid.MVVM.StarterKit
{
    ...
    /// </summary>
    /// <remarks>
    /// Sibling order is draw order in a UI: it is what brings a panel to the front, what reorders a list the player
    /// dragged, and the only way to do either without touching <see cref="Canvas.sortingOrder"/> and taking the whole
    /// canvas with it.
    /// <para/>
