...
namespace Aspid.MVVM.StarterKit
{
    ...
    public sealed class ColorBlockAlphaConverter : IConverter<ColorBlock, ColorBlock>
    {
        ...
        // Calls ColorAlphaConverter.Apply directly: an instance per push would allocate on every notification.
        private Color Fade(Color color) => ColorAlphaConverter.Apply(this, color, _alpha, _mode);
    }
}
