...
namespace Aspid.MVVM.StarterKit
{
        ...
        where TEnum : struct, Enum
    {
        ...
        /// <remarks>Serialization only: no string table assigned — every lookup reports it and shows the fallback.</remarks>
        protected LocalizedEnumConverter() { }

        /// <param name="table">
        /// The string table the keys are looked up in. Without one, every lookup is reported as an
        /// error and answered by the fallback.
        /// </param>
