...
namespace Aspid.MVVM.StarterKit
{
        ...
        ITwoWayConverter<Vector4, Quaternion>
    {
        ...
        Quaternion IConverter<Vector4, Quaternion>.Convert(Vector4 value) => ConvertBack(value);

        Vector4 ITwoWayConverter<Vector4, Quaternion>.ConvertBack(Quaternion value) => Convert(value);
        ...
        public Quaternion ConvertBack(Vector4 value)
        {
            ...
            // A non-unit rotation scales and shears what it lands on. Four zeroes have no direction
            // to scale back to, so they answer with the identity.
