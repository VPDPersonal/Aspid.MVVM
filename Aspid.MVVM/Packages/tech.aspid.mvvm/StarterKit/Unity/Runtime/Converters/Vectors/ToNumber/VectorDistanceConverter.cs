...
namespace Aspid.MVVM.StarterKit
{
        ...
        IConverter<Vector2, float>
    {
        ...
        {
            // An empty target is not a misconfiguration: the authored point is what it measures to.
        ...
        // A two-component position lives in a 2D scene, where depth is not a distance.
