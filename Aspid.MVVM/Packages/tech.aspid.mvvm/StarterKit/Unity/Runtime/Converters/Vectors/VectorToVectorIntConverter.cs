...
namespace Aspid.MVVM.StarterKit
{
        ...
        ITwoWayConverter<Vector3, Vector3Int>
    {
        ...
        Vector3 ITwoWayConverter<Vector3, Vector3Int>.ConvertBack(Vector3Int value) => value;

        // Reported on every push: an undeclared mode is a misconfiguration, not data. Rounding to
        // nearest is the mode a new converter starts in, and the caller rounds what comes back.
