...
namespace Aspid.MVVM.Tests
{
    ...
    /// </summary>
    [TestFixture]
    public sealed class ComponentNumberReverseChannelTests : SceneFixture
    {
            ...
            where TBinder : MonoBinder
        {
            ...
            Assert.AreEqual(BindMode.OneWayToSource, binder.Mode, "Could not set the binder's mode through SerializedObject");
            return binder;
        }
