...
{
    /// <summary>
    /// Tests for <see cref="DelegateOneTimeBinder{T}"/> and <see cref="DelegateOneTimeBinder{TTarget,T}"/>.
    /// </summary>
    [TestFixture]
    public sealed class DelegateOneTimeBinderTests
    {
        [Test]
        public void Ctor_FixesTheModeToOneTime()
        {
            var binder = new DelegateOneTimeBinder<int>(_ => { });
        ...
        public void BoundThroughAMember_TheSecondPush_DoesNotReachTheSetter()
        {
            ...
            var binder = new DelegateOneTimeBinder<int>(received.Add);
        ...
        {
            var binder = new DelegateOneTimeBinder<object, int>(new object(), (_, _) => { });
        ...
        {
            var received = new List<int>();
            var binder = new DelegateOneTimeBinder<object, int>(new object(), (_, value) => received.Add(value));
            var member = new OneWayBindableMember<int>(1);
