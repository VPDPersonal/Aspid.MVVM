...
{
    /// <summary>
    /// Tests for <see cref="GenericTwoWayBinder{T}"/> and <see cref="GenericTwoWayBinder{TTarget,T}"/>.
    /// </summary>
    [TestFixture]
    public sealed class GenericTwoWayBinderTests
    {
        [Test]
        public void FactoryCtor_NullSetValue_Throws() =>
            Assert.Throws<ArgumentNullException>(() => new GenericTwoWayBinder<int>(setValue: null));

        [Test]
        public void SubscribeCtor_NullSubscribe_Throws() =>
            Assert.Throws<ArgumentNullException>(
                () => new GenericTwoWayBinder<int>(subscribe: null, setValue: _ => { }));

        [Test]
        public void SetValue_ForwardsToTheSetter()
        {
            var received = 0;
            var binder = new GenericTwoWayBinder<int>(value => received = value);
        ...
        public void SubscribeCtor_InvokingTheCallback_RaisesValueChanged()
        {
            ...
            var binder = new GenericTwoWayBinder<int>(c => callback = c, _ => { });
        ...
        {
            var received = new List<int>();
            var binder = new GenericTwoWayBinder<int>(_ => { }, getValueOnBound: () => 3);
        ...
        {
            var received = new List<int>();
            var binder = new GenericTwoWayBinder<int>(_ => { }, getValueOnUnbinding: () => 8);
            var member = new TwoWayBindableMember<int>(0, received.Add);
        ...
        public void TargetFactoryCtor_NullTarget_Throws() =>
            Assert.Throws<ArgumentNullException>(
                () => new GenericTwoWayBinder<object, int>(null, (_, _) => { }, getValueOnBound: _ => 1));

        [Test]
        public void TargetFactoryCtor_NullSetValue_Throws() =>
            Assert.Throws<ArgumentNullException>(
                () => new GenericTwoWayBinder<object, int>(new object(), (Action<object, int>)null, getValueOnBound: _ => 1));
        ...
        public void TargetFactoryCtor_BothFactoriesNull_Throws() =>
            Assert.Throws<ArgumentException>(
                () => new GenericTwoWayBinder<object, int>(new object(), (_, _) => { }));

        [Test]
        public void TargetSubscribeCtor_NullSubscribe_Throws() =>
            Assert.Throws<ArgumentNullException>(
                () => new GenericTwoWayBinder<object, int>(new object(), null, (_, _) => { }));
        ...
        public void TargetSetValue_ForwardsTheTargetAndTheValue()
        {
            ...
            var receivedValue = 0;
            var binder = new GenericTwoWayBinder<object, int>(target, (t, value) =>
            {
                receivedTarget = t;
                receivedValue = value;
            }, getValueOnBound: _ => 0);
        ...
        public void TargetSubscribeCtor_ReceivesTheTargetAndTheCallback()
        {
            ...
            object? receivedTarget = null;
            Action<int>? callback = null;
            var binder = new GenericTwoWayBinder<object, int>(target, (t, c) =>
            {
                receivedTarget = t;
                callback = c;
            }, (_, _) => { });
        ...
        public void TargetGetValueOnBound_IsPushedWithTheTargetOnBind()
        {
            ...
            object? receivedTarget = null;
            var received = new List<int>();
            var binder = new GenericTwoWayBinder<object, int>(target, (_, _) => { }, t =>
            {
                receivedTarget = t;
                return 6;
            });
