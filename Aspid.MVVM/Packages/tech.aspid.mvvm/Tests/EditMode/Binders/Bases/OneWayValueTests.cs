...
{
    /// <summary>
    /// Tests for <see cref="OneWayValue{T}"/>.
    /// </summary>
    [TestFixture]
    public sealed class OneWayValueTests
    {
        [Test]
        public void Ctor_TwoWayMode_Throws() =>
            Assert.Throws<InvalidOperationException>(() => new OneWayValue<int>(0, BindMode.TwoWay));

        [Test]
        public void Ctor_OneWayToSourceMode_Throws() =>
            Assert.Throws<InvalidOperationException>(() => new OneWayValue<int>(0, BindMode.OneWayToSource));

        [Test]
        public void DefaultCtor_StoresTheDefaultValue()
        {
            var binder = new OneWayValue<int>();
        ...
        {
            var binder = new OneWayValue<int>(7);
        ...
        {
            var binder = new OneWayValue<int>(0);
        ...
        {
            var binder = new OneWayValue<int>(0, new DoublingConverter());
        ...
        {
            var binder = new OneWayValue<int>(9);
