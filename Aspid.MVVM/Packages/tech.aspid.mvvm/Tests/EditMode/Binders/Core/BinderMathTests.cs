...
namespace Aspid.MVVM.Tests
{
    ...
    /// </remarks>
    [TestFixture]
    public sealed class BinderMathTests : SceneFixture
    {
        ...
        public void CanvasGroupAlphaBinder_WithNaN_LeavesTheComponentFinite()
        {
            ...
            Assert.IsTrue(BinderMath.IsFinite(canvasGroup.alpha), $"The component received {canvasGroup.alpha}");
        }

        [Test]
        public void ImageFillBinder_WithNaN_LeavesTheComponentFinite()
        {
            var gameObject = Spawn("Fill");
            ...
            Assert.IsTrue(BinderMath.IsFinite(image.fillAmount), $"The component received {image.fillAmount}");
        }
    }
}
