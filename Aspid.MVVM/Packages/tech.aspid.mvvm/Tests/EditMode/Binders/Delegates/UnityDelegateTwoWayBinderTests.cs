...
{
    /// <summary>
    /// Tests for <see cref="UnityDelegateTwoWayBinder{T}"/> and <see cref="UnityDelegateTwoWayBinder{TTarget,T}"/>.
    /// </summary>
    [TestFixture]
    public sealed class UnityDelegateTwoWayBinderTests
    {
        [Test]
        public void FactoryCtor_NullSetValue_Throws() =>
            Assert.Throws<ArgumentNullException>(() => new UnityDelegateTwoWayBinder<int>(setValue: null));

        [Test]
        public void SetValue_ForwardsToTheSetter()
        {
            var received = 0;
            var binder = new UnityDelegateTwoWayBinder<int>(value => received = value);
        ...
        public void SubscribeCtor_InvokingTheCallback_RaisesValueChanged()
        {
            ...
            var binder = new UnityDelegateTwoWayBinder<int>(c => callback = c, _ => { });
        ...
        {
            var received = new List<int>();
            var binder = new UnityDelegateTwoWayBinder<int>(_ => { }, getValueOnBound: () => 3);
        ...
        {
            var received = new List<int>();
            var binder = new UnityDelegateTwoWayBinder<int>(_ => { }, getValueOnUnbinding: () => 8);
            var member = new TwoWayBindableMember<int>(0, received.Add);
        ...
        public void TargetFactoryCtor_NullTarget_Throws() =>
            Assert.Throws<ArgumentNullException>(
                () => new UnityDelegateTwoWayBinder<object, int>(null, (_, _) => { }, getValueOnBound: _ => 1));

        [Test]
        public void TargetFactoryCtor_NullSetValue_Throws() =>
            Assert.Throws<ArgumentNullException>(
                () => new UnityDelegateTwoWayBinder<object, int>(new object(), (UnityAction<object, int>)null, getValueOnBound: _ => 1));
        ...
        public void TargetFactoryCtor_BothFactoriesNull_Throws() =>
            Assert.Throws<ArgumentException>(
                () => new UnityDelegateTwoWayBinder<object, int>(new object(), (_, _) => { }));
        ...
        public void TargetSetValue_ForwardsTheTargetAndTheValue()
        {
            ...
            var receivedValue = 0;
            var binder = new UnityDelegateTwoWayBinder<object, int>(target, (t, value) =>
            {
                receivedTarget = t;
                receivedValue = value;
            }, getValueOnBound: _ => 0);
        ...
        public void TargetSubscribeCtor_ReceivesTheTargetAndTheCallback()
        {
            ...
            object? receivedTarget = null;
            UnityAction<int>? callback = null;
            var binder = new UnityDelegateTwoWayBinder<object, int>(target, (t, c) =>
            {
                receivedTarget = t;
                callback = c;
            }, (_, _) => { });
        ...
        public void TargetGetValueOnBound_IsPushedWithTheTargetOnBind()
        {
            ...
            object? receivedTarget = null;
            var received = new List<int>();
            var binder = new UnityDelegateTwoWayBinder<object, int>(target, (_, _) => { }, t =>
            {
                receivedTarget = t;
                return 6;
            });
