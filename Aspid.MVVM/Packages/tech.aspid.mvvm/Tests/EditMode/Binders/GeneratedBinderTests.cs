...
namespace Aspid.MVVM.Tests
{
    ...
    /// </remarks>
    [TestFixture]
    public sealed class GeneratedBinderTests
    {
        ...
        {
            Assert.IsNotNull(typeof(GeneratedCanvasScalerReferencePixelsBinder), "Сериализуемая половина не сгенерирована");
            Assert.IsNotNull(typeof(GeneratedCanvasScalerReferencePixelsMonoBinder), "MonoBehaviour-половина не сгенерирована");
        }
        ...
        public void TheGeneratedMonoBinder_StandsOnTheBaseTheValueTypeAsksFor()
        {
            Assert.IsTrue(
                ...
                "Сгенерированный биндер стоит не на float-базе");
        }

        [Test]
        public void TheGeneratedBinder_WritesTheProperty()
        {
            var gameObject = new GameObject("Scaler");
            ...
            Assert.AreEqual(50f, scaler.referencePixelsPerUnit, 0.001f, "Сгенерированный биндер не записал свойство");
        }
        ...
        public void TheGeneratedMonoBinder_CarriesItsMenuAndContextNames()
        {
            ...
            Assert.AreEqual("Aspid/MVVM/Binders/UI/CanvasScaler/CanvasScaler Binder – Reference Pixels Per Unit",
                menu.componentMenu, "Путь меню не доехал до сгенерированного биндера");

            Assert.AreEqual(typeof(CanvasScaler), context.Type, "Тип для контекстного меню не тот");
            Assert.Contains("m_ReferencePixelsPerUnit", context.SerializePropertyNames, "Имя сериализуемого свойства не доехало");
        }
        ...
        public void TheGeneratedSerializableBinder_AcceptsItsTarget()
        {
            ...
            Assert.IsTrue(new GeneratedCanvasScalerReferencePixelsBinder(scaler).IsBind);
        }
    }
}
