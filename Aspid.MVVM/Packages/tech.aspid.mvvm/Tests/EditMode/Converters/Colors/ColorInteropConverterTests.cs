...
namespace Aspid.MVVM.Tests
{
    ...
    /// </summary>
    /// <remarks>
    /// The exposure maths is unclamped on purpose, and the <see cref="Color32"/> pair rides Unity's implicit operators; every expectation is the value the conversion actually produces.
    /// </remarks>
    [TestFixture]
    public sealed class ColorInteropConverterTests
    {
