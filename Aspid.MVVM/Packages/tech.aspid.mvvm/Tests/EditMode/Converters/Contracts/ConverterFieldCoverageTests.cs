...
namespace Aspid.MVVM.Tests
{
    ...
    /// </remarks>
    [TestFixture]
    public sealed class ConverterFieldCoverageTests
    {
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// It is empty: every converter field in the package now offers something. It stays declared
        /// so the next field added without a converter behind it lands in a list that already knows
