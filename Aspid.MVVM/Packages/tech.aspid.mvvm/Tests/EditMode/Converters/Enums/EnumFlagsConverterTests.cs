...
namespace Aspid.MVVM.Tests
{
    ...
    /// </summary>
    /// <remarks>
    /// Every non-<c>[Flags]</c> assertion is paired with the same operation on a <c>[Flags]</c> enum, so a passthrough cannot pass by being a no-op everywhere.
    /// </remarks>
    [TestFixture]
    public sealed class EnumFlagsConverterTests
    {
