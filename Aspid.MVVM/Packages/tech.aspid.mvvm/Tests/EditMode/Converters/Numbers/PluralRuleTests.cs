...
namespace Aspid.MVVM.Tests
{
    ...
    /// </summary>
    [TestFixture]
    public sealed class PluralRuleTests
    {
        [TestCase(0)]
        [TestCase(1)]
        [TestCase(2)]
        ...
        [TestCase(1, "yabloko")]
        [TestCase(21, "yabloko")]
        [TestCase(101, "yabloko")]
        [TestCase(2, "yabloka")]
        [TestCase(4, "yabloka")]
        [TestCase(22, "yabloka")]
        [TestCase(104, "yabloka")]
        [TestCase(0, "yablok")]
        [TestCase(5, "yablok")]
        ...
        public void UnauthoredWord_TheGrammarNeverReachedFor_IsSilent() =>
            Assert.AreEqual("yabloko", new EastSlavicPluralRule("yabloko", string.Empty, "yablok").Convert(1));

        private static void ExpectMissingWordError() =>
            LogAssert.Expect(LogType.Error, new Regex("PluralRule.*no word is authored"));

        private static EastSlavicPluralRule Russian() => new("yabloko", "yabloka", "yablok");
