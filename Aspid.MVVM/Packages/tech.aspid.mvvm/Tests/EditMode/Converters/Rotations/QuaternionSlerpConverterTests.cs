...
namespace Aspid.MVVM.Tests
{
    ...
    /// </remarks>
    [TestFixture]
    public sealed class QuaternionSlerpConverterTests
    {
        [TestCase(0f, 0f)]
        [TestCase(0.5f, 45f)]
        [TestCase(1f, 90f)]
        ...
        // A dial authored 0° → 350° travels ten degrees backwards, so its midpoint is 355°, not the
        // 175° that sweeping the long way round would give.
        [Test]
