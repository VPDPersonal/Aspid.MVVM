...
{
    /// <summary>
    /// Coverage for <see cref="QuaternionVector4Converter"/>'s forward and reverse pass — the raw
    /// component order, the default normalization and its opt-out, and the round trip.
    /// </summary>
    [TestFixture]
    public sealed class QuaternionVector4ConverterTests
    {
