...
namespace Aspid.MVVM.Tests
{
    ...
    /// </summary>
    /// <remarks>
    /// Expected values were taken from running the converter; two rows assert behaviour the source documentation contradicts and are named to say so.
    /// </remarks>
    [TestFixture]
    public sealed class RichTextSanitizeConverterTests
    {
        // --- pass-through --------------------------------------------------------------------
