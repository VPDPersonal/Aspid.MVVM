...
{
    /// <summary>
    /// Coverage for <see cref="ValueToStringConverter{T}"/>, including its
    ...
    /// </remarks>
    [TestFixture]
    public sealed class ValueToStringConverterTests
    {
        [Test]
        public void Convert_Null_ReturnsNull() =>
            Assert.IsNull(new ValueToStringConverter<string>("{0}").Convert(null));

        [Test]
        public void Convert_NoFormat_FallsBackToToString() =>
            Assert.AreEqual("42", new ValueToStringConverter<int>().Convert(42));

        [TestCase("")]
        [TestCase(" ")]
        [TestCase("\t")]
        public void Convert_BlankFormat_FallsBackToToString(string format) =>
            Assert.AreEqual("42", new ValueToStringConverter<int>(format).Convert(42));

        [Test]
        public void Convert_NullFormat_FallsBackToToString() =>
            Assert.AreEqual("42", new ValueToStringConverter<int>(null).Convert(42));

        [Test]
        public void Convert_Format_IsAppliedToTheTypedValue() =>
            Assert.AreEqual("HP: 42", new ValueToStringConverter<int>("HP: {0}").Convert(42));
        ...
        public void Convert_FormatWithoutPlaceholder_ReturnsTheFormatVerbatim() =>
            Assert.AreEqual("F2", new ValueToStringConverter<float>("F2").Convert(3.5f));
        ...
        public void Convert_BrokenFormat_FallsBackToToStringInsteadOfThrowing()
        {
            ...
            Assert.AreEqual("42", new ValueToStringConverter<int>("{0}/{1}").Convert(42));
        }
        ...
        public void Convert_UnbalancedBrace_FallsBackToToStringInsteadOfThrowing()
        {
            ...
            Assert.AreEqual("42", new ValueToStringConverter<int>("HP: {0} {").Convert(42));
        }
        ...
        public void Convert_BrokenFormat_LogsEveryFailure()
        {
            ...
            var converter = new ValueToStringConverter<int>("{0}/{1}");
            converter.Convert(1);
            converter.Convert(2);
            converter.Convert(3);
        }
        ...
        public void Convert_BrokenFormatAndThrowingToString_ReturnsTheTypeName()
        {
            ...
            Assert.AreEqual("Unprintable", new ValueToStringConverter<Unprintable>("{").Convert(new Unprintable()));
        }
        ...
        private sealed class ThrowingFormat : ValueToStringConverter<int>
        {
            public ThrowingFormat()
                : base("{0}") { }

            protected override string Format(int value, string format) =>
        ...
        private sealed class CustomErrorFallback : ValueToStringConverter<int>
        {
        ...
        public void ObjectClosedForm_NoFormat_FallsBackToToString() =>
            Assert.AreEqual("42", new ValueToStringConverter<object>().Convert(42));

        [Test]
        public void ObjectClosedForm_Format_IsApplied() =>
            Assert.AreEqual("HP: 42", new ValueToStringConverter<object>("HP: {0}").Convert(42));

        [Test]
        public void ObjectClosedForm_Null_ReturnsNull() =>
            Assert.IsNull(new ValueToStringConverter<object>("HP: {0}").Convert(null));
        ...
        [Test]
        public void BareTimeSpanPattern_ReturnsThePatternVerbatim() =>
            Assert.AreEqual("mm\\:ss", new ValueToStringConverter<TimeSpan>("mm\\:ss").Convert(TimeSpan.FromSeconds(305)));
    }
}
