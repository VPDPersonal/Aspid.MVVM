...
namespace Aspid.MVVM.Tests
{
    ...
    /// </summary>
    [TestFixture]
    public sealed class DateTimeCompareConverterTests
    {
        ...
        // The single-argument constructor leaves the reference source at its default, Now.
        [Test]
        public void Convert_DefaultReferenceSource_ComparesAgainstNow()
        {
