...
namespace Aspid.MVVM.StarterKit.Tests
{
    ...
    /// excluded, or it reads the wrong field and writes the right color into the wrong state. Both need
    /// a source block whose five colors all differ, which is why nothing here starts from
    /// <see cref="ColorBlock.defaultColorBlock"/> — it gives highlighted and selected the same color.
    /// <para>
    ...
    /// </remarks>
    [TestFixture]
    internal sealed class ColorBlockMaskConverterTests
    {
