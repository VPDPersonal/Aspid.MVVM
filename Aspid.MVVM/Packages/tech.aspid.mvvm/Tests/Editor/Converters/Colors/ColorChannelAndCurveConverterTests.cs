...
namespace Aspid.MVVM.StarterKit.Tests
{
    ...
    /// sorted stops. Several assertions pin behavior the XML docs describe loosely and carry a comment
    /// saying which claim they are measured against.
    /// </remarks>
    [TestFixture]
    internal sealed class ColorChannelAndCurveConverterTests
    {
