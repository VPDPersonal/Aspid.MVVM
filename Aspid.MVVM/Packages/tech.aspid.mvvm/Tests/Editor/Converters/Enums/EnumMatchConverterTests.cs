...
namespace Aspid.MVVM.StarterKit.Tests
{
    ...
    /// </summary>
    /// <remarks>
    /// Basic equality against a flat enum is covered by <c>EssentialConverterTests</c>; this fixture
    /// covers the flags-aware tests and the failure mode.
    /// </remarks>
    [TestFixture]
    internal sealed class EnumMatchConverterTests
    {
