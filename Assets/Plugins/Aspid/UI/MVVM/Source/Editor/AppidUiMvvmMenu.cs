...
{
    public static class AppidUiMvvmMenu
    {
        private const string ProfilerMenu = "Tools/Aspid/Settings/Enable Profiler";
        private const string ProfilerDefine = "ASPID_UI_MVVM_UNITY_PROFILER_DISABLED";
        
        private const string BinderLogMenu = "Tools/Aspid/Settings/Enable Binder Log";
        private const string BinderLogDefine = "ASPID_UI_MVVM_BINDER_LOG_DISABLED";
        
        private const string CheckForEditorMenu = "Tools/Aspid/Settings/Checks for Editor";
        private const string CheckForEditorDefine = "ASPID_UI_EDITOR_DISABLED";
