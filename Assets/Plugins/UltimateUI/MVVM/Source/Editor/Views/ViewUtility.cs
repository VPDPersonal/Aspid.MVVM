...
namespace UltimateUI.MVVM.Unity.Views
{
    ...
    public static class ViewUtility
    {
            ...
            BindersWithFieldName newBinders)
        {
            ...
            void DeleteDuplicateMonoBinderValidable(in ChangedBinder changedBinder)
            {
                foreach (var newBinder in changedBinder.NewBinders)
                {
                    ...
                    if (string.IsNullOrEmpty(newBinder.Id) && !changedBinder.OldBinders.Contains(newBinder))
            ...
            where TView : Component, IView
        {
            ...
            var bindersOnScene = view.GetComponentsInChildren<IMonoBinderValidable>()
            ...
            BindersWithFieldName newBinders)
        {
            ...
            foreach (var key in oldBinders.Keys)
            {
                ...
                Debug.Log("key " + key);
                changedFields[index++] = new ChangedBinder(oldValue, newValue);
            }
