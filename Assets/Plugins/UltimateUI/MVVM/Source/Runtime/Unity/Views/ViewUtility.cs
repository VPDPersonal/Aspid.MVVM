...
//                 return fieldType == typeof(MonoBinding[]);
//             });
//             
//             foreach (var field in fields)
//             {
//                 var binders = (MonoBinding[])field.GetValue(view);
//                 
...
#if UNITY_EDITOR
        public static void FindAllBinders(IView view, IReadOnlyCollection<MonoBinding> bindersOnScene)
        {
            // var type = view.GetType();
            //
            // const BindingFlags bindingFlags = BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic ;
