---
title: "Class AudioSourcePanStereoBinder"
sidebar_label: "AudioSourcePanStereoBinder"
description: "Class AudioSourcePanStereoBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class AudioSourcePanStereoBinder {#Aspid_MVVM_StarterKit_AudioSourcePanStereoBinder}
...
```csharp
[Serializable]
public class AudioSourcePanStereoBinder : TargetFloatBinder<AudioSource>, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, INumberReverseBinder, IReverseBinder<int>, IReverseBinder<long>, IReverseBinder<float>, IReverseBinder<double>, IBinder
```
...
[BinderExtensions.BindSafely\<AudioSourcePanStereoBinder\>\(AudioSourcePanStereoBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<AudioSourcePanStereoBinder\>\(AudioSourcePanStereoBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<AudioSourcePanStereoBinder\>\(AudioSourcePanStereoBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### AudioSourcePanStereoBinder\(\) {#Aspid_MVVM_StarterKit_AudioSourcePanStereoBinder__ctor}

```csharp
protected AudioSourcePanStereoBinder()
```
...
### AudioSourcePanStereoBinder\(AudioSource, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_AudioSourcePanStereoBinder__ctor_UnityEngine_AudioSource_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_AudioSourcePanStereoBinder_Property}
...
### GetConvertedValue\(float\) {#Aspid_MVVM_StarterKit_AudioSourcePanStereoBinder_GetConvertedValue_System_Single_}
