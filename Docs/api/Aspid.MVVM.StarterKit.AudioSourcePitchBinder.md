---
title: "Class AudioSourcePitchBinder"
sidebar_label: "AudioSourcePitchBinder"
description: "Class AudioSourcePitchBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class AudioSourcePitchBinder {#Aspid_MVVM_StarterKit_AudioSourcePitchBinder}
...
```csharp
[Serializable]
public class AudioSourcePitchBinder : TargetFloatBinder<AudioSource>, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, INumberReverseBinder, IReverseBinder<int>, IReverseBinder<long>, IReverseBinder<float>, IReverseBinder<double>, IBinder
```
...
[BinderExtensions.BindSafely\<AudioSourcePitchBinder\>\(AudioSourcePitchBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<AudioSourcePitchBinder\>\(AudioSourcePitchBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<AudioSourcePitchBinder\>\(AudioSourcePitchBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### AudioSourcePitchBinder\(\) {#Aspid_MVVM_StarterKit_AudioSourcePitchBinder__ctor}

```csharp
protected AudioSourcePitchBinder()
```
...
### AudioSourcePitchBinder\(AudioSource, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_AudioSourcePitchBinder__ctor_UnityEngine_AudioSource_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_AudioSourcePitchBinder_Property}
...
### GetConvertedValue\(float\) {#Aspid_MVVM_StarterKit_AudioSourcePitchBinder_GetConvertedValue_System_Single_}
