---
title: "Class AudioSourcePitchSwitcherBinder"
sidebar_label: "AudioSourcePitchSwitcherBinder"
description: "Class AudioSourcePitchSwitcherBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class AudioSourcePitchSwitcherBinder {#Aspid_MVVM_StarterKit_AudioSourcePitchSwitcherBinder}
...
```csharp
[Serializable]
public sealed class AudioSourcePitchSwitcherBinder : SwitcherBinder<AudioSource, float>, IRebindableBinder, IBinder<bool>, IBinder
```
...
[BinderExtensions.BindSafely\<AudioSourcePitchSwitcherBinder\>\(AudioSourcePitchSwitcherBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<AudioSourcePitchSwitcherBinder\>\(AudioSourcePitchSwitcherBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<AudioSourcePitchSwitcherBinder\>\(AudioSourcePitchSwitcherBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### AudioSourcePitchSwitcherBinder\(AudioSource, float, float, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_AudioSourcePitchSwitcherBinder__ctor_UnityEngine_AudioSource_System_Single_System_Single_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}

```csharp
public AudioSourcePitchSwitcherBinder(AudioSource target, float trueValue, float falseValue, IConverter<float, float> converter = null, BindMode mode = BindMode.OneWay)
```
...
### SetValue\(float\) {#Aspid_MVVM_StarterKit_AudioSourcePitchSwitcherBinder_SetValue_System_Single_}
