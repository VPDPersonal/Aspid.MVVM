---
title: "Class AudioSourcePriorityBinder"
sidebar_label: "AudioSourcePriorityBinder"
description: "Class AudioSourcePriorityBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class AudioSourcePriorityBinder {#Aspid_MVVM_StarterKit_AudioSourcePriorityBinder}
...
[TargetBinder\<AudioSource, int\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
[TargetIntBinder\<AudioSource\>](Aspid.MVVM.StarterKit.TargetIntBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<AudioSourcePriorityBinder\>\(AudioSourcePriorityBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<AudioSourcePriorityBinder\>\(AudioSourcePriorityBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<AudioSourcePriorityBinder\>\(AudioSourcePriorityBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### AudioSourcePriorityBinder\(\) {#Aspid_MVVM_StarterKit_AudioSourcePriorityBinder__ctor}

```csharp
protected AudioSourcePriorityBinder()
```
...
### AudioSourcePriorityBinder\(AudioSource, IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_AudioSourcePriorityBinder__ctor_UnityEngine_AudioSource_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_AudioSourcePriorityBinder_Property}
...
### GetConvertedValue\(int\) {#Aspid_MVVM_StarterKit_AudioSourcePriorityBinder_GetConvertedValue_System_Int32_}
