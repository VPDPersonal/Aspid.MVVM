---
title: "Class AudioSourceReverbZoneMixBinder"
sidebar_label: "AudioSourceReverbZoneMixBinder"
description: "Class AudioSourceReverbZoneMixBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class AudioSourceReverbZoneMixBinder {#Aspid_MVVM_StarterKit_AudioSourceReverbZoneMixBinder}
...
```csharp
[Serializable]
public class AudioSourceReverbZoneMixBinder : TargetFloatBinder<AudioSource>, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, INumberReverseBinder, IReverseBinder<int>, IReverseBinder<long>, IReverseBinder<float>, IReverseBinder<double>, IBinder
```
...
[BinderExtensions.BindSafely\<AudioSourceReverbZoneMixBinder\>\(AudioSourceReverbZoneMixBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<AudioSourceReverbZoneMixBinder\>\(AudioSourceReverbZoneMixBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<AudioSourceReverbZoneMixBinder\>\(AudioSourceReverbZoneMixBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### AudioSourceReverbZoneMixBinder\(\) {#Aspid_MVVM_StarterKit_AudioSourceReverbZoneMixBinder__ctor}

```csharp
protected AudioSourceReverbZoneMixBinder()
```
...
### AudioSourceReverbZoneMixBinder\(AudioSource, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_AudioSourceReverbZoneMixBinder__ctor_UnityEngine_AudioSource_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_AudioSourceReverbZoneMixBinder_Property}
...
### GetConvertedValue\(float\) {#Aspid_MVVM_StarterKit_AudioSourceReverbZoneMixBinder_GetConvertedValue_System_Single_}
