---
title: "Class AudioSourceSpreadBinder"
sidebar_label: "AudioSourceSpreadBinder"
description: "Class AudioSourceSpreadBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class AudioSourceSpreadBinder {#Aspid_MVVM_StarterKit_AudioSourceSpreadBinder}
...
```csharp
[Serializable]
public class AudioSourceSpreadBinder : TargetFloatBinder<AudioSource>, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, INumberReverseBinder, IReverseBinder<int>, IReverseBinder<long>, IReverseBinder<float>, IReverseBinder<double>, IBinder
```
...
[BinderExtensions.BindSafely\<AudioSourceSpreadBinder\>\(AudioSourceSpreadBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<AudioSourceSpreadBinder\>\(AudioSourceSpreadBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<AudioSourceSpreadBinder\>\(AudioSourceSpreadBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### AudioSourceSpreadBinder\(\) {#Aspid_MVVM_StarterKit_AudioSourceSpreadBinder__ctor}

```csharp
protected AudioSourceSpreadBinder()
```
...
### AudioSourceSpreadBinder\(AudioSource, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_AudioSourceSpreadBinder__ctor_UnityEngine_AudioSource_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_AudioSourceSpreadBinder_Property}
...
### GetConvertedValue\(float\) {#Aspid_MVVM_StarterKit_AudioSourceSpreadBinder_GetConvertedValue_System_Single_}
