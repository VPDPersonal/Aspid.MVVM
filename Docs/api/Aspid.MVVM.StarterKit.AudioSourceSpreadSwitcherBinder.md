---
title: "Class AudioSourceSpreadSwitcherBinder"
sidebar_label: "AudioSourceSpreadSwitcherBinder"
description: "Class AudioSourceSpreadSwitcherBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class AudioSourceSpreadSwitcherBinder {#Aspid_MVVM_StarterKit_AudioSourceSpreadSwitcherBinder}
...
```csharp
[Serializable]
public sealed class AudioSourceSpreadSwitcherBinder : SwitcherBinder<AudioSource, float>, IRebindableBinder, IBinder<bool>, IBinder
```
...
[BinderExtensions.BindSafely\<AudioSourceSpreadSwitcherBinder\>\(AudioSourceSpreadSwitcherBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<AudioSourceSpreadSwitcherBinder\>\(AudioSourceSpreadSwitcherBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<AudioSourceSpreadSwitcherBinder\>\(AudioSourceSpreadSwitcherBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### AudioSourceSpreadSwitcherBinder\(AudioSource, float, float, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_AudioSourceSpreadSwitcherBinder__ctor_UnityEngine_AudioSource_System_Single_System_Single_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}

```csharp
public AudioSourceSpreadSwitcherBinder(AudioSource target, float trueValue, float falseValue, IConverter<float, float> converter = null, BindMode mode = BindMode.OneWay)
```
...
### SetValue\(float\) {#Aspid_MVVM_StarterKit_AudioSourceSpreadSwitcherBinder_SetValue_System_Single_}
