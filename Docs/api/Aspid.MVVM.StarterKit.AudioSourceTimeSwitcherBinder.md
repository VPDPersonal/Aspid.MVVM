---
title: "Class AudioSourceTimeSwitcherBinder"
sidebar_label: "AudioSourceTimeSwitcherBinder"
description: "Class AudioSourceTimeSwitcherBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class AudioSourceTimeSwitcherBinder {#Aspid_MVVM_StarterKit_AudioSourceTimeSwitcherBinder}
...
```csharp
[Serializable]
public sealed class AudioSourceTimeSwitcherBinder : SwitcherBinder<AudioSource, float>, IRebindableBinder, IBinder<bool>, IBinder
```
...
[BinderExtensions.BindSafely\<AudioSourceTimeSwitcherBinder\>\(AudioSourceTimeSwitcherBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<AudioSourceTimeSwitcherBinder\>\(AudioSourceTimeSwitcherBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<AudioSourceTimeSwitcherBinder\>\(AudioSourceTimeSwitcherBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### AudioSourceTimeSwitcherBinder\(AudioSource, float, float, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_AudioSourceTimeSwitcherBinder__ctor_UnityEngine_AudioSource_System_Single_System_Single_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}

```csharp
public AudioSourceTimeSwitcherBinder(AudioSource target, float trueValue, float falseValue, IConverter<float, float> converter = null, BindMode mode = BindMode.OneWay)
```
...
### SetValue\(float\) {#Aspid_MVVM_StarterKit_AudioSourceTimeSwitcherBinder_SetValue_System_Single_}
