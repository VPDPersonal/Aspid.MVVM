---
title: "Class AudioSourceVolumeSwitcherBinder"
sidebar_label: "AudioSourceVolumeSwitcherBinder"
description: "Class AudioSourceVolumeSwitcherBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class AudioSourceVolumeSwitcherBinder {#Aspid_MVVM_StarterKit_AudioSourceVolumeSwitcherBinder}
...
```csharp
[Serializable]
public sealed class AudioSourceVolumeSwitcherBinder : SwitcherBinder<AudioSource, float>, IRebindableBinder, IBinder<bool>, IBinder
```
...
[BinderExtensions.BindSafely\<AudioSourceVolumeSwitcherBinder\>\(AudioSourceVolumeSwitcherBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<AudioSourceVolumeSwitcherBinder\>\(AudioSourceVolumeSwitcherBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<AudioSourceVolumeSwitcherBinder\>\(AudioSourceVolumeSwitcherBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### AudioSourceVolumeSwitcherBinder\(AudioSource, float, float, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_AudioSourceVolumeSwitcherBinder__ctor_UnityEngine_AudioSource_System_Single_System_Single_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}

```csharp
public AudioSourceVolumeSwitcherBinder(AudioSource target, float trueValue, float falseValue, IConverter<float, float> converter = null, BindMode mode = BindMode.OneWay)
```
...
### SetValue\(float\) {#Aspid_MVVM_StarterKit_AudioSourceVolumeSwitcherBinder_SetValue_System_Single_}
