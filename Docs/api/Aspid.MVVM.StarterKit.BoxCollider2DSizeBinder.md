---
title: "Class BoxCollider2DSizeBinder"
sidebar_label: "BoxCollider2DSizeBinder"
description: "Class BoxCollider2DSizeBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class BoxCollider2DSizeBinder {#Aspid_MVVM_StarterKit_BoxCollider2DSizeBinder}
...
[TargetBinder\<BoxCollider2D\>](Aspid.MVVM.TargetBinder-1.md) ← 
[TargetBinder\<BoxCollider2D, Vector2\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
...
[BinderExtensions.BindSafely\<BoxCollider2DSizeBinder\>\(BoxCollider2DSizeBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<BoxCollider2DSizeBinder\>\(BoxCollider2DSizeBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<BoxCollider2DSizeBinder\>\(BoxCollider2DSizeBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### BoxCollider2DSizeBinder\(\) {#Aspid_MVVM_StarterKit_BoxCollider2DSizeBinder__ctor}

```csharp
protected BoxCollider2DSizeBinder()
```
...
### BoxCollider2DSizeBinder\(BoxCollider2D, IConverter\<Vector2, Vector2\>, BindMode\) {#Aspid_MVVM_StarterKit_BoxCollider2DSizeBinder__ctor_UnityEngine_BoxCollider2D_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector2_UnityEngine_Vector2__Aspid_MVVM_BindMode_}

```csharp
public BoxCollider2DSizeBinder(BoxCollider2D target, IConverter<Vector2, Vector2> converter = null, BindMode mode = BindMode.OneWay)
```

#### Parameters

`target` BoxCollider2D
...
### Property {#Aspid_MVVM_StarterKit_BoxCollider2DSizeBinder_Property}
