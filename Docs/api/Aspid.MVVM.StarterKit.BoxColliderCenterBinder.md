---
title: "Class BoxColliderCenterBinder"
sidebar_label: "BoxColliderCenterBinder"
description: "Class BoxColliderCenterBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class BoxColliderCenterBinder {#Aspid_MVVM_StarterKit_BoxColliderCenterBinder}
...
[BinderExtensions.BindSafely\<BoxColliderCenterBinder\>\(BoxColliderCenterBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<BoxColliderCenterBinder\>\(BoxColliderCenterBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<BoxColliderCenterBinder\>\(BoxColliderCenterBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### BoxColliderCenterBinder\(\) {#Aspid_MVVM_StarterKit_BoxColliderCenterBinder__ctor}

```csharp
protected BoxColliderCenterBinder()
```
...
### BoxColliderCenterBinder\(BoxCollider, IConverter\<Vector3, Vector3\>, BindMode\) {#Aspid_MVVM_StarterKit_BoxColliderCenterBinder__ctor_UnityEngine_BoxCollider_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector3_UnityEngine_Vector3__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_BoxColliderCenterBinder_Property}
