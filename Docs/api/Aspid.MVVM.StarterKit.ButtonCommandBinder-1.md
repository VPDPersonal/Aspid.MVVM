---
title: "Class ButtonCommandBinder<T>"
sidebar_label: "ButtonCommandBinder<T>"
description: "Class ButtonCommandBinder<T> — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ButtonCommandBinder\<T\> {#Aspid_MVVM_StarterKit_ButtonCommandBinder_1}
...
```csharp
[Serializable]
public class ButtonCommandBinder<T> : TargetBinder<Button>, IRebindableBinder, IBinder<IRelayCommand<T>>, IBinder
```
...
[BinderExtensions.BindSafely\<ButtonCommandBinder\<T\>\>\(ButtonCommandBinder\<T\>?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ButtonCommandBinder\<T\>\>\(ButtonCommandBinder\<T\>?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ButtonCommandBinder\<T\>\>\(ButtonCommandBinder\<T\>?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### ButtonCommandBinder\(Button, T, BindMode\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_1__ctor_UnityEngine_UI_Button__0_Aspid_MVVM_BindMode_}
...
### ButtonCommandBinder\(Button, T, ICanExecuteHandler, BindMode\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_1__ctor_UnityEngine_UI_Button__0_Aspid_MVVM_StarterKit_ICanExecuteHandler_Aspid_MVVM_BindMode_}

```csharp
public ButtonCommandBinder(Button target, T param, ICanExecuteHandler customInteractable, BindMode mode = BindMode.OneWay)
```
...
### ButtonCommandBinder\(Button, T, InteractableMode, BindMode\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_1__ctor_UnityEngine_UI_Button__0_Aspid_MVVM_StarterKit_InteractableMode_Aspid_MVVM_BindMode_}

```csharp
public ButtonCommandBinder(Button target, T param, InteractableMode interactableMode, BindMode mode = BindMode.OneWay)
```
...
### Param {#Aspid_MVVM_StarterKit_ButtonCommandBinder_1_Param}
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_1_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_1_OnUnbound}
...
### SetValue\(IRelayCommand\<T\>\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_1_SetValue_Aspid_MVVM_IRelayCommand__0__}
