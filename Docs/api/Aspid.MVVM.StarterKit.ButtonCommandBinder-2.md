---
title: "Class ButtonCommandBinder<T1, T2>"
sidebar_label: "ButtonCommandBinder<T1, T2>"
description: "Class ButtonCommandBinder<T1, T2> — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ButtonCommandBinder\<T1, T2\> {#Aspid_MVVM_StarterKit_ButtonCommandBinder_2}
...
```csharp
[Serializable]
public class ButtonCommandBinder<T1, T2> : TargetBinder<Button>, IRebindableBinder, IBinder<IRelayCommand<T1, T2>>, IBinder
```
...
[BinderExtensions.BindSafely\<ButtonCommandBinder\<T1, T2\>\>\(ButtonCommandBinder\<T1, T2\>?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ButtonCommandBinder\<T1, T2\>\>\(ButtonCommandBinder\<T1, T2\>?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ButtonCommandBinder\<T1, T2\>\>\(ButtonCommandBinder\<T1, T2\>?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### ButtonCommandBinder\(Button, T1, T2, BindMode\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_2__ctor_UnityEngine_UI_Button__0__1_Aspid_MVVM_BindMode_}
...
### ButtonCommandBinder\(Button, T1, T2, ICanExecuteHandler, BindMode\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_2__ctor_UnityEngine_UI_Button__0__1_Aspid_MVVM_StarterKit_ICanExecuteHandler_Aspid_MVVM_BindMode_}

```csharp
public ButtonCommandBinder(Button target, T1 param1, T2 param2, ICanExecuteHandler customInteractable, BindMode mode = BindMode.OneWay)
```
...
### ButtonCommandBinder\(Button, T1, T2, InteractableMode, BindMode\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_2__ctor_UnityEngine_UI_Button__0__1_Aspid_MVVM_StarterKit_InteractableMode_Aspid_MVVM_BindMode_}

```csharp
public ButtonCommandBinder(Button target, T1 param1, T2 param2, InteractableMode interactableMode, BindMode mode = BindMode.OneWay)
```
...
### Param1 {#Aspid_MVVM_StarterKit_ButtonCommandBinder_2_Param1}
...
### Param2 {#Aspid_MVVM_StarterKit_ButtonCommandBinder_2_Param2}
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_2_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_2_OnUnbound}
...
### SetValue\(IRelayCommand\<T1, T2\>\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_2_SetValue_Aspid_MVVM_IRelayCommand__0__1__}
