---
title: "Class ButtonCommandBinder<T1, T2, T3, T4>"
sidebar_label: "ButtonCommandBinder<T1, T2, T3, T4>"
description: "Class ButtonCommandBinder<T1, T2, T3, T4> — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ButtonCommandBinder\<T1, T2, T3, T4\> {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4}
...
```csharp
[Serializable]
public class ButtonCommandBinder<T1, T2, T3, T4> : TargetBinder<Button>, IRebindableBinder, IBinder<IRelayCommand<T1, T2, T3, T4>>, IBinder
```
...
[IBinder\<IRelayCommand\<T1, T2, T3, T4\>\>](Aspid.MVVM.IBinder-1.md), 
[IBinder](Aspid.MVVM.IBinder.md)


#### Extension Methods

[BinderExtensions.BindSafely\<ButtonCommandBinder\<T1, T2, T3, T4\>\>\(ButtonCommandBinder\<T1, T2, T3, T4\>?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ButtonCommandBinder\<T1, T2, T3, T4\>\>\(ButtonCommandBinder\<T1, T2, T3, T4\>?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ButtonCommandBinder\<T1, T2, T3, T4\>\>\(ButtonCommandBinder\<T1, T2, T3, T4\>?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### ButtonCommandBinder\(Button, T1, T2, T3, T4, BindMode\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4__ctor_UnityEngine_UI_Button__0__1__2__3_Aspid_MVVM_BindMode_}
...
### ButtonCommandBinder\(Button, T1, T2, T3, T4, ICanExecuteHandler, BindMode\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4__ctor_UnityEngine_UI_Button__0__1__2__3_Aspid_MVVM_StarterKit_ICanExecuteHandler_Aspid_MVVM_BindMode_}
...
### ButtonCommandBinder\(Button, T1, T2, T3, T4, InteractableMode, BindMode\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4__ctor_UnityEngine_UI_Button__0__1__2__3_Aspid_MVVM_StarterKit_InteractableMode_Aspid_MVVM_BindMode_}
...
### Param1 {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4_Param1}
...
### Param2 {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4_Param2}
...
### Param3 {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4_Param3}
...
### Param4 {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4_Param4}

Gets or sets the parameter passed to the command.

```csharp
public virtual T4 Param4 { get; set; }
```
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4_OnUnbound}
...
### SetValue\(IRelayCommand\<T1, T2, T3, T4\>\) {#Aspid_MVVM_StarterKit_ButtonCommandBinder_4_SetValue_Aspid_MVVM_IRelayCommand__0__1__2__3__}
