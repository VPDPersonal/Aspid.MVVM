---
title: "Class CanvasGroupAlphaBinder"
sidebar_label: "CanvasGroupAlphaBinder"
description: "Class CanvasGroupAlphaBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class CanvasGroupAlphaBinder {#Aspid_MVVM_StarterKit_CanvasGroupAlphaBinder}
...
```csharp
[Serializable]
public class CanvasGroupAlphaBinder : TargetFloatBinder<CanvasGroup>, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, INumberReverseBinder, IReverseBinder<int>, IReverseBinder<long>, IReverseBinder<float>, IReverseBinder<double>, IBinder
```
...
[TargetBinder\<CanvasGroup, float\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
[TargetFloatBinder\<CanvasGroup\>](Aspid.MVVM.StarterKit.TargetFloatBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<CanvasGroupAlphaBinder\>\(CanvasGroupAlphaBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<CanvasGroupAlphaBinder\>\(CanvasGroupAlphaBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<CanvasGroupAlphaBinder\>\(CanvasGroupAlphaBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### CanvasGroupAlphaBinder\(\) {#Aspid_MVVM_StarterKit_CanvasGroupAlphaBinder__ctor}

```csharp
protected CanvasGroupAlphaBinder()
```
...
### CanvasGroupAlphaBinder\(CanvasGroup, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_CanvasGroupAlphaBinder__ctor_UnityEngine_CanvasGroup_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_CanvasGroupAlphaBinder_Property}
