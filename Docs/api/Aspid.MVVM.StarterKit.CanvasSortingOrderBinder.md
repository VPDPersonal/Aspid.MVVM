---
title: "Class CanvasSortingOrderBinder"
sidebar_label: "CanvasSortingOrderBinder"
description: "Class CanvasSortingOrderBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class CanvasSortingOrderBinder {#Aspid_MVVM_StarterKit_CanvasSortingOrderBinder}
...
[TargetBinder\<Canvas, int\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
[TargetIntBinder\<Canvas\>](Aspid.MVVM.StarterKit.TargetIntBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<CanvasSortingOrderBinder\>\(CanvasSortingOrderBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<CanvasSortingOrderBinder\>\(CanvasSortingOrderBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<CanvasSortingOrderBinder\>\(CanvasSortingOrderBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### CanvasSortingOrderBinder\(\) {#Aspid_MVVM_StarterKit_CanvasSortingOrderBinder__ctor}

```csharp
protected CanvasSortingOrderBinder()
```
...
### CanvasSortingOrderBinder\(Canvas, IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_CanvasSortingOrderBinder__ctor_UnityEngine_Canvas_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}

```csharp
public CanvasSortingOrderBinder(Canvas target, IConverter<int, int> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_CanvasSortingOrderBinder_Property}
