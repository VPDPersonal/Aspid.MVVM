---
title: "Class CapsuleColliderCenterBinder"
sidebar_label: "CapsuleColliderCenterBinder"
description: "Class CapsuleColliderCenterBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class CapsuleColliderCenterBinder {#Aspid_MVVM_StarterKit_CapsuleColliderCenterBinder}
...
[TargetBinder\<CapsuleCollider, Vector3\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
...
[BinderExtensions.BindSafely\<CapsuleColliderCenterBinder\>\(CapsuleColliderCenterBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<CapsuleColliderCenterBinder\>\(CapsuleColliderCenterBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<CapsuleColliderCenterBinder\>\(CapsuleColliderCenterBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### CapsuleColliderCenterBinder\(\) {#Aspid_MVVM_StarterKit_CapsuleColliderCenterBinder__ctor}

```csharp
protected CapsuleColliderCenterBinder()
```
...
### CapsuleColliderCenterBinder\(CapsuleCollider, IConverter\<Vector3, Vector3\>, BindMode\) {#Aspid_MVVM_StarterKit_CapsuleColliderCenterBinder__ctor_UnityEngine_CapsuleCollider_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector3_UnityEngine_Vector3__Aspid_MVVM_BindMode_}

```csharp
public CapsuleColliderCenterBinder(CapsuleCollider target, IConverter<Vector3, Vector3> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_CapsuleColliderCenterBinder_Property}
