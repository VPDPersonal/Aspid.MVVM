---
title: "Class CapsuleColliderDirectionBinder"
sidebar_label: "CapsuleColliderDirectionBinder"
description: "Class CapsuleColliderDirectionBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class CapsuleColliderDirectionBinder {#Aspid_MVVM_StarterKit_CapsuleColliderDirectionBinder}
...
[TargetBinder\<CapsuleCollider, int\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
[TargetIntBinder\<CapsuleCollider\>](Aspid.MVVM.StarterKit.TargetIntBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<CapsuleColliderDirectionBinder\>\(CapsuleColliderDirectionBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<CapsuleColliderDirectionBinder\>\(CapsuleColliderDirectionBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<CapsuleColliderDirectionBinder\>\(CapsuleColliderDirectionBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### CapsuleColliderDirectionBinder\(\) {#Aspid_MVVM_StarterKit_CapsuleColliderDirectionBinder__ctor}

```csharp
protected CapsuleColliderDirectionBinder()
```
...
### CapsuleColliderDirectionBinder\(CapsuleCollider, IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_CapsuleColliderDirectionBinder__ctor_UnityEngine_CapsuleCollider_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}

```csharp
public CapsuleColliderDirectionBinder(CapsuleCollider target, IConverter<int, int> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_CapsuleColliderDirectionBinder_Property}
