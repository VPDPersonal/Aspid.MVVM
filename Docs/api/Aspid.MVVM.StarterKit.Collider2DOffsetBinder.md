---
title: "Class Collider2DOffsetBinder"
sidebar_label: "Collider2DOffsetBinder"
description: "Class Collider2DOffsetBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class Collider2DOffsetBinder {#Aspid_MVVM_StarterKit_Collider2DOffsetBinder}
...
[TargetBinder\<Collider2D, Vector2\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
...
[BinderExtensions.BindSafely\<Collider2DOffsetBinder\>\(Collider2DOffsetBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<Collider2DOffsetBinder\>\(Collider2DOffsetBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<Collider2DOffsetBinder\>\(Collider2DOffsetBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### Collider2DOffsetBinder\(\) {#Aspid_MVVM_StarterKit_Collider2DOffsetBinder__ctor}

```csharp
protected Collider2DOffsetBinder()
```
...
### Collider2DOffsetBinder\(Collider2D, IConverter\<Vector2, Vector2\>, BindMode\) {#Aspid_MVVM_StarterKit_Collider2DOffsetBinder__ctor_UnityEngine_Collider2D_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector2_UnityEngine_Vector2__Aspid_MVVM_BindMode_}

```csharp
public Collider2DOffsetBinder(Collider2D target, IConverter<Vector2, Vector2> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_Collider2DOffsetBinder_Property}
