---
title: "Class ColliderExcludeLayersBinder"
sidebar_label: "ColliderExcludeLayersBinder"
description: "Class ColliderExcludeLayersBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ColliderExcludeLayersBinder {#Aspid_MVVM_StarterKit_ColliderExcludeLayersBinder}
...
[BinderExtensions.BindSafely\<ColliderExcludeLayersBinder\>\(ColliderExcludeLayersBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ColliderExcludeLayersBinder\>\(ColliderExcludeLayersBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ColliderExcludeLayersBinder\>\(ColliderExcludeLayersBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### ColliderExcludeLayersBinder\(\) {#Aspid_MVVM_StarterKit_ColliderExcludeLayersBinder__ctor}

```csharp
protected ColliderExcludeLayersBinder()
```
...
### ColliderExcludeLayersBinder\(Collider, IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_ColliderExcludeLayersBinder__ctor_UnityEngine_Collider_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}

```csharp
public ColliderExcludeLayersBinder(Collider target, IConverter<int, int> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_ColliderExcludeLayersBinder_Property}
