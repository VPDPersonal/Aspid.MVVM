---
title: "Class ColliderIncludeLayersBinder"
sidebar_label: "ColliderIncludeLayersBinder"
description: "Class ColliderIncludeLayersBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ColliderIncludeLayersBinder {#Aspid_MVVM_StarterKit_ColliderIncludeLayersBinder}
...
[TargetBinder\<Collider, int\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
[TargetIntBinder\<Collider\>](Aspid.MVVM.StarterKit.TargetIntBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<ColliderIncludeLayersBinder\>\(ColliderIncludeLayersBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ColliderIncludeLayersBinder\>\(ColliderIncludeLayersBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ColliderIncludeLayersBinder\>\(ColliderIncludeLayersBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Remarks

The mask travels as an <a href="https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/integral-numeric-types">int</a>, which [`LayerMask`](https://docs.unity3d.com/ScriptReference/LayerMask.html) converts to and from.

## Constructors

### ColliderIncludeLayersBinder\(\) {#Aspid_MVVM_StarterKit_ColliderIncludeLayersBinder__ctor}

```csharp
protected ColliderIncludeLayersBinder()
```
...
### ColliderIncludeLayersBinder\(Collider, IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_ColliderIncludeLayersBinder__ctor_UnityEngine_Collider_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}

```csharp
public ColliderIncludeLayersBinder(Collider target, IConverter<int, int> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_ColliderIncludeLayersBinder_Property}
