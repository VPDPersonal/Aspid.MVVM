---
title: "Class DropdownAlphaFadeSpeedBinder"
sidebar_label: "DropdownAlphaFadeSpeedBinder"
description: "Class DropdownAlphaFadeSpeedBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class DropdownAlphaFadeSpeedBinder {#Aspid_MVVM_StarterKit_DropdownAlphaFadeSpeedBinder}
...
```csharp
[Serializable]
public class DropdownAlphaFadeSpeedBinder : TargetFloatBinder<TMP_Dropdown>, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, INumberReverseBinder, IReverseBinder<int>, IReverseBinder<long>, IReverseBinder<float>, IReverseBinder<double>, IBinder
```
...
[TargetBinder\<TMP\_Dropdown, float\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
[TargetFloatBinder\<TMP\_Dropdown\>](Aspid.MVVM.StarterKit.TargetFloatBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<DropdownAlphaFadeSpeedBinder\>\(DropdownAlphaFadeSpeedBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<DropdownAlphaFadeSpeedBinder\>\(DropdownAlphaFadeSpeedBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<DropdownAlphaFadeSpeedBinder\>\(DropdownAlphaFadeSpeedBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### DropdownAlphaFadeSpeedBinder\(\) {#Aspid_MVVM_StarterKit_DropdownAlphaFadeSpeedBinder__ctor}

```csharp
protected DropdownAlphaFadeSpeedBinder()
```
...
### DropdownAlphaFadeSpeedBinder\(TMP\_Dropdown, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_DropdownAlphaFadeSpeedBinder__ctor_TMPro_TMP_Dropdown_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_DropdownAlphaFadeSpeedBinder_Property}
