---
title: "Class DropdownCommandBinder"
sidebar_label: "DropdownCommandBinder"
description: "Class DropdownCommandBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class DropdownCommandBinder {#Aspid_MVVM_StarterKit_DropdownCommandBinder}
...
```csharp
[Serializable]
public sealed class DropdownCommandBinder : TargetBinder<TMP_Dropdown>, IRebindableBinder, IBinder<IRelayCommand<int>>, IBinder<IRelayCommand<long>>, IBinder
```
...
[BinderExtensions.BindSafely\<DropdownCommandBinder\>\(DropdownCommandBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<DropdownCommandBinder\>\(DropdownCommandBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<DropdownCommandBinder\>\(DropdownCommandBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### DropdownCommandBinder\(TMP\_Dropdown, BindMode\) {#Aspid_MVVM_StarterKit_DropdownCommandBinder__ctor_TMPro_TMP_Dropdown_Aspid_MVVM_BindMode_}
...
### DropdownCommandBinder\(TMP\_Dropdown, ICanExecuteHandler, BindMode\) {#Aspid_MVVM_StarterKit_DropdownCommandBinder__ctor_TMPro_TMP_Dropdown_Aspid_MVVM_StarterKit_ICanExecuteHandler_Aspid_MVVM_BindMode_}

```csharp
public DropdownCommandBinder(TMP_Dropdown target, ICanExecuteHandler customInteractable, BindMode mode = BindMode.OneWay)
```
...
### DropdownCommandBinder\(TMP\_Dropdown, InteractableMode, BindMode\) {#Aspid_MVVM_StarterKit_DropdownCommandBinder__ctor_TMPro_TMP_Dropdown_Aspid_MVVM_StarterKit_InteractableMode_Aspid_MVVM_BindMode_}

```csharp
public DropdownCommandBinder(TMP_Dropdown target, InteractableMode interactableMode, BindMode mode = BindMode.OneWay)
```
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_DropdownCommandBinder_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_DropdownCommandBinder_OnUnbound}
...
### SetValue\(IRelayCommand\<int\>\) {#Aspid_MVVM_StarterKit_DropdownCommandBinder_SetValue_Aspid_MVVM_IRelayCommand_System_Int32__}
...
### SetValue\(IRelayCommand\<long\>\) {#Aspid_MVVM_StarterKit_DropdownCommandBinder_SetValue_Aspid_MVVM_IRelayCommand_System_Int64__}
