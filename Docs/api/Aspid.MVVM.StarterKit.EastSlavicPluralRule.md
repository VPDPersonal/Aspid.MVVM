---
title: "Class EastSlavicPluralRule"
sidebar_label: "EastSlavicPluralRule"
description: "Class EastSlavicPluralRule — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class EastSlavicPluralRule {#Aspid_MVVM_StarterKit_EastSlavicPluralRule}
...
```csharp
[Serializable]
[TypeSelectorDisplay(Group = "Aspid/Plural Rule", Name = "East Slavic", Tooltip = "Three words picked by the last digit, with the teens excepted: Russian, Ukrainian")]
public sealed class EastSlavicPluralRule : PluralRule, IConverter<long, string>, IConverter
```
...
### EastSlavicPluralRule\(string, string, string, string?\) {#Aspid_MVVM_StarterKit_EastSlavicPluralRule__ctor_System_String_System_String_System_String_System_String_}
...
The word for a count ending in one, except in the teens.

`few` [string](https://learn.microsoft.com/dotnet/api/system.string)

The word for a count ending in two to four, except in the teens.

`many` [string](https://learn.microsoft.com/dotnet/api/system.string)

The word for every other count, the whole 11-14 window included.
...
### Word\(long\) {#Aspid_MVVM_StarterKit_EastSlavicPluralRule_Word_System_Int64_}
