---
title: "Class ElementSliderValueMonoBinder"
sidebar_label: "ElementSliderValueMonoBinder"
description: "Class ElementSliderValueMonoBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ElementSliderValueMonoBinder {#Aspid_MVVM_StarterKit_ElementSliderValueMonoBinder}
...
public sealed class ElementSliderValueMonoBinder : VisualElementMonoBinder<Slider>, IMonoBinderValidatable, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, IReverseBinder<float>, IBinder
```
...
[VisualElementMonoBinder\<Slider\>](Aspid.MVVM.StarterKit.VisualElementMonoBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<ElementSliderValueMonoBinder\>\(ElementSliderValueMonoBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ElementSliderValueMonoBinder\>\(ElementSliderValueMonoBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ElementSliderValueMonoBinder\>\(ElementSliderValueMonoBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_ElementSliderValueMonoBinder_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_ElementSliderValueMonoBinder_OnUnbound}
...
### SetValue\(float\) {#Aspid_MVVM_StarterKit_ElementSliderValueMonoBinder_SetValue_System_Single_}
...
### ValueChanged {#Aspid_MVVM_StarterKit_ElementSliderValueMonoBinder_ValueChanged}
