---
title: "Class FloatBinder"
sidebar_label: "FloatBinder"
description: "Class FloatBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class FloatBinder {#Aspid_MVVM_StarterKit_FloatBinder}
...
```csharp
[Serializable]
public abstract class FloatBinder : Binder<float>, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, INumberReverseBinder, IReverseBinder<int>, IReverseBinder<long>, IReverseBinder<float>, IReverseBinder<double>, IBinder
```
...
[BinderExtensions.BindSafely\<FloatBinder\>\(FloatBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<FloatBinder\>\(FloatBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<FloatBinder\>\(FloatBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### FloatBinder\(\) {#Aspid_MVVM_StarterKit_FloatBinder__ctor}
...
### FloatBinder\(IConverter\<float, float\>?, BindMode\) {#Aspid_MVVM_StarterKit_FloatBinder__ctor_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### SendInitialValueToSource\(\) {#Aspid_MVVM_StarterKit_FloatBinder_SendInitialValueToSource}
