---
title: "Class FloatMonoBinder"
sidebar_label: "FloatMonoBinder"
description: "Class FloatMonoBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class FloatMonoBinder {#Aspid_MVVM_StarterKit_FloatMonoBinder}
...
```csharp
public abstract class FloatMonoBinder : MonoBinder<float>, IMonoBinderValidatable, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, INumberReverseBinder, IReverseBinder<int>, IReverseBinder<long>, IReverseBinder<float>, IReverseBinder<double>, IBinder
```
...
[MonoBinder\<float\>](Aspid.MVVM.StarterKit.MonoBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<FloatMonoBinder\>\(FloatMonoBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<FloatMonoBinder\>\(FloatMonoBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<FloatMonoBinder\>\(FloatMonoBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Methods

### RaiseNumberValueChanged\(float\) {#Aspid_MVVM_StarterKit_FloatMonoBinder_RaiseNumberValueChanged_System_Single_}

Sends <code class="paramref">value</code> to the ViewModel on every numeric channel, after <code>GetConvertedBackValue</code>.
...
<code>RaiseValueChanged</code> alone reaches only a ViewModel member of the property's own type.

### SendInitialValueToSource\(\) {#Aspid_MVVM_StarterKit_FloatMonoBinder_SendInitialValueToSource}
...
the class-level <code>ValueChanged</code>, not to the channel.
