---
title: "Class FloatToTimeSpanConverterAsset"
sidebar_label: "FloatToTimeSpanConverterAsset"
description: "Class FloatToTimeSpanConverterAsset — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class FloatToTimeSpanConverterAsset {#Aspid_MVVM_StarterKit_FloatToTimeSpanConverterAsset}
...
public sealed class FloatToTimeSpanConverterAsset : ConverterAsset<float, TimeSpan>, IConverter<float, TimeSpan>, IConverter
```
...
Object ← 
ScriptableObject ← 
[ConverterAsset\<float, TimeSpan\>](Aspid.MVVM.StarterKit.ConverterAsset-2.md) ← 
