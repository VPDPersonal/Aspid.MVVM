---
title: "Class GridLayoutGroupCellSizeBinder"
sidebar_label: "GridLayoutGroupCellSizeBinder"
description: "Class GridLayoutGroupCellSizeBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class GridLayoutGroupCellSizeBinder {#Aspid_MVVM_StarterKit_GridLayoutGroupCellSizeBinder}
...
[TargetBinder\<GridLayoutGroup, Vector2\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
...
[BinderExtensions.BindSafely\<GridLayoutGroupCellSizeBinder\>\(GridLayoutGroupCellSizeBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<GridLayoutGroupCellSizeBinder\>\(GridLayoutGroupCellSizeBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<GridLayoutGroupCellSizeBinder\>\(GridLayoutGroupCellSizeBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### GridLayoutGroupCellSizeBinder\(\) {#Aspid_MVVM_StarterKit_GridLayoutGroupCellSizeBinder__ctor}

```csharp
protected GridLayoutGroupCellSizeBinder()
```
...
### GridLayoutGroupCellSizeBinder\(GridLayoutGroup, IConverter\<Vector2, Vector2\>, BindMode\) {#Aspid_MVVM_StarterKit_GridLayoutGroupCellSizeBinder__ctor_UnityEngine_UI_GridLayoutGroup_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector2_UnityEngine_Vector2__Aspid_MVVM_BindMode_}

```csharp
public GridLayoutGroupCellSizeBinder(GridLayoutGroup target, IConverter<Vector2, Vector2> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_GridLayoutGroupCellSizeBinder_Property}
