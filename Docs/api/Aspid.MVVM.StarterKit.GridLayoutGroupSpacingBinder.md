---
title: "Class GridLayoutGroupSpacingBinder"
sidebar_label: "GridLayoutGroupSpacingBinder"
description: "Class GridLayoutGroupSpacingBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class GridLayoutGroupSpacingBinder {#Aspid_MVVM_StarterKit_GridLayoutGroupSpacingBinder}
...
[BinderExtensions.BindSafely\<GridLayoutGroupSpacingBinder\>\(GridLayoutGroupSpacingBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<GridLayoutGroupSpacingBinder\>\(GridLayoutGroupSpacingBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<GridLayoutGroupSpacingBinder\>\(GridLayoutGroupSpacingBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### GridLayoutGroupSpacingBinder\(\) {#Aspid_MVVM_StarterKit_GridLayoutGroupSpacingBinder__ctor}

```csharp
protected GridLayoutGroupSpacingBinder()
```
...
### GridLayoutGroupSpacingBinder\(GridLayoutGroup, IConverter\<Vector2, Vector2\>, BindMode\) {#Aspid_MVVM_StarterKit_GridLayoutGroupSpacingBinder__ctor_UnityEngine_UI_GridLayoutGroup_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector2_UnityEngine_Vector2__Aspid_MVVM_BindMode_}

```csharp
public GridLayoutGroupSpacingBinder(GridLayoutGroup target, IConverter<Vector2, Vector2> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_GridLayoutGroupSpacingBinder_Property}
