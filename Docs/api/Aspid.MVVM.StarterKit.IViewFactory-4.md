---
title: "Interface IViewFactory<T1, T2, T3, TView>"
sidebar_label: "IViewFactory<T1, T2, T3, TView>"
description: "Interface IViewFactory<T1, T2, T3, TView> — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Interface IViewFactory\<T1, T2, T3, TView\> {#Aspid_MVVM_StarterKit_IViewFactory_4}
...
```csharp
public interface IViewFactory<in T1, in T2, in T3, TView> : IViewFactoryWithKey<T1, T2, T3, TView>, IViewFactoryRelease<TView> where TView : IView
```
...
### Create\(IViewModel?, T1?, T2?, T3?\) {#Aspid_MVVM_StarterKit_IViewFactory_4_Create_Aspid_MVVM_IViewModel__0__1__2_}

Creates a view for <code class="paramref">viewModel</code>.

```csharp
TView Create(IViewModel? viewModel, T1? param1, T2? param2, T3? param3)
```
