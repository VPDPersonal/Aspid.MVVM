---
title: "Class ImageFillOriginBinder"
sidebar_label: "ImageFillOriginBinder"
description: "Class ImageFillOriginBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ImageFillOriginBinder {#Aspid_MVVM_StarterKit_ImageFillOriginBinder}
...
[TargetBinder\<Image, int\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
[TargetIntBinder\<Image\>](Aspid.MVVM.StarterKit.TargetIntBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<ImageFillOriginBinder\>\(ImageFillOriginBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ImageFillOriginBinder\>\(ImageFillOriginBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ImageFillOriginBinder\>\(ImageFillOriginBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Remarks

The value indexes the origin enum of the current [`fillMethod`](https://docs.unity3d.com/ScriptReference/UI-Image-fillMethod.html).

## Constructors

### ImageFillOriginBinder\(\) {#Aspid_MVVM_StarterKit_ImageFillOriginBinder__ctor}

```csharp
protected ImageFillOriginBinder()
```
...
### ImageFillOriginBinder\(Image, IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_ImageFillOriginBinder__ctor_UnityEngine_UI_Image_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}

```csharp
public ImageFillOriginBinder(Image target, IConverter<int, int> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_ImageFillOriginBinder_Property}
