---
title: "Class ImageFillSwitcherBinder"
sidebar_label: "ImageFillSwitcherBinder"
description: "Class ImageFillSwitcherBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ImageFillSwitcherBinder {#Aspid_MVVM_StarterKit_ImageFillSwitcherBinder}
...
```csharp
[Serializable]
public sealed class ImageFillSwitcherBinder : SwitcherBinder<Image, float>, IRebindableBinder, IBinder<bool>, IBinder
```
...
[SwitcherBinder\<Image, float\>](Aspid.MVVM.StarterKit.SwitcherBinder-2.md) ← 
...
[BinderExtensions.BindSafely\<ImageFillSwitcherBinder\>\(ImageFillSwitcherBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ImageFillSwitcherBinder\>\(ImageFillSwitcherBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ImageFillSwitcherBinder\>\(ImageFillSwitcherBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### ImageFillSwitcherBinder\(Image, float, float, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_ImageFillSwitcherBinder__ctor_UnityEngine_UI_Image_System_Single_System_Single_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}

```csharp
public ImageFillSwitcherBinder(Image target, float trueValue, float falseValue, IConverter<float, float> converter = null, BindMode mode = BindMode.OneWay)
```
...
### SetValue\(float\) {#Aspid_MVVM_StarterKit_ImageFillSwitcherBinder_SetValue_System_Single_}
