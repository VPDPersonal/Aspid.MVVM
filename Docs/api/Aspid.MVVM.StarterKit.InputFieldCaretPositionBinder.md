---
title: "Class InputFieldCaretPositionBinder"
sidebar_label: "InputFieldCaretPositionBinder"
description: "Class InputFieldCaretPositionBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class InputFieldCaretPositionBinder {#Aspid_MVVM_StarterKit_InputFieldCaretPositionBinder}
...
[BinderExtensions.BindSafely\<InputFieldCaretPositionBinder\>\(InputFieldCaretPositionBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<InputFieldCaretPositionBinder\>\(InputFieldCaretPositionBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<InputFieldCaretPositionBinder\>\(InputFieldCaretPositionBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### InputFieldCaretPositionBinder\(\) {#Aspid_MVVM_StarterKit_InputFieldCaretPositionBinder__ctor}

```csharp
protected InputFieldCaretPositionBinder()
```
...
### InputFieldCaretPositionBinder\(TMP\_InputField, IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_InputFieldCaretPositionBinder__ctor_TMPro_TMP_InputField_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}

```csharp
public InputFieldCaretPositionBinder(TMP_InputField target, IConverter<int, int> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_InputFieldCaretPositionBinder_Property}
