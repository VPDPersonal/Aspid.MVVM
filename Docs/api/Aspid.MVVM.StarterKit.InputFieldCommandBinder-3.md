---
title: "Class InputFieldCommandBinder<T1, T2, T3>"
sidebar_label: "InputFieldCommandBinder<T1, T2, T3>"
description: "Class InputFieldCommandBinder<T1, T2, T3> — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class InputFieldCommandBinder\<T1, T2, T3\> {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3}
...
```csharp
[Serializable]
public class InputFieldCommandBinder<T1, T2, T3> : TargetBinder<TMP_InputField>, IRebindableBinder, IBinder<IRelayCommand<string, T1, T2, T3>>, IBinder
```
...
[BinderExtensions.BindSafely\<InputFieldCommandBinder\<T1, T2, T3\>\>\(InputFieldCommandBinder\<T1, T2, T3\>?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<InputFieldCommandBinder\<T1, T2, T3\>\>\(InputFieldCommandBinder\<T1, T2, T3\>?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<InputFieldCommandBinder\<T1, T2, T3\>\>\(InputFieldCommandBinder\<T1, T2, T3\>?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### InputFieldCommandBinder\(TMP\_InputField, T1, T2, T3, BindMode\) {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3__ctor_TMPro_TMP_InputField__0__1__2_Aspid_MVVM_BindMode_}
...
### InputFieldCommandBinder\(TMP\_InputField, T1, T2, T3, UpdateInputFieldEvent, BindMode\) {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3__ctor_TMPro_TMP_InputField__0__1__2_Aspid_MVVM_StarterKit_UpdateInputFieldEvent_Aspid_MVVM_BindMode_}
...
### InputFieldCommandBinder\(TMP\_InputField, T1, T2, T3, ICanExecuteHandler, UpdateInputFieldEvent, BindMode\) {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3__ctor_TMPro_TMP_InputField__0__1__2_Aspid_MVVM_StarterKit_ICanExecuteHandler_Aspid_MVVM_StarterKit_UpdateInputFieldEvent_Aspid_MVVM_BindMode_}

```csharp
public InputFieldCommandBinder(TMP_InputField target, T1 param1, T2 param2, T3 param3, ICanExecuteHandler customInteractable, UpdateInputFieldEvent updateEvent = UpdateInputFieldEvent.OnValueChanged, BindMode mode = BindMode.OneWay)
```
...
### InputFieldCommandBinder\(TMP\_InputField, T1, T2, T3, InteractableMode, UpdateInputFieldEvent, BindMode\) {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3__ctor_TMPro_TMP_InputField__0__1__2_Aspid_MVVM_StarterKit_InteractableMode_Aspid_MVVM_StarterKit_UpdateInputFieldEvent_Aspid_MVVM_BindMode_}

```csharp
public InputFieldCommandBinder(TMP_InputField target, T1 param1, T2 param2, T3 param3, InteractableMode interactableMode, UpdateInputFieldEvent updateEvent = UpdateInputFieldEvent.OnValueChanged, BindMode mode = BindMode.OneWay)
```
...
### Param1 {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3_Param1}
...
### Param2 {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3_Param2}
...
### Param3 {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3_Param3}
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3_OnUnbound}
...
### SetValue\(IRelayCommand\<string, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_InputFieldCommandBinder_3_SetValue_Aspid_MVVM_IRelayCommand_System_String__0__1__2__}
