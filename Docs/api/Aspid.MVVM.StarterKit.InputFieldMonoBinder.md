---
title: "Class InputFieldMonoBinder"
sidebar_label: "InputFieldMonoBinder"
description: "Class InputFieldMonoBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class InputFieldMonoBinder {#Aspid_MVVM_StarterKit_InputFieldMonoBinder}
...
[BinderExtensions.BindSafely\<InputFieldMonoBinder\>\(InputFieldMonoBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<InputFieldMonoBinder\>\(InputFieldMonoBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<InputFieldMonoBinder\>\(InputFieldMonoBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Methods

### OnBound\(\) {#Aspid_MVVM_StarterKit_InputFieldMonoBinder_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_InputFieldMonoBinder_OnUnbound}
...
### OnValidate\(\) {#Aspid_MVVM_StarterKit_InputFieldMonoBinder_OnValidate}
...
### SetValue\(string\) {#Aspid_MVVM_StarterKit_InputFieldMonoBinder_SetValue_System_String_}
...
### SetValue\(int\) {#Aspid_MVVM_StarterKit_InputFieldMonoBinder_SetValue_System_Int32_}
...
### SetValue\(long\) {#Aspid_MVVM_StarterKit_InputFieldMonoBinder_SetValue_System_Int64_}
...
### SetValue\(float\) {#Aspid_MVVM_StarterKit_InputFieldMonoBinder_SetValue_System_Single_}
...
### SetValue\(double\) {#Aspid_MVVM_StarterKit_InputFieldMonoBinder_SetValue_System_Double_}
...
### ValueChanged {#Aspid_MVVM_StarterKit_InputFieldMonoBinder_ValueChanged}
