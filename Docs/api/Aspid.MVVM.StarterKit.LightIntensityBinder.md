---
title: "Class LightIntensityBinder"
sidebar_label: "LightIntensityBinder"
description: "Class LightIntensityBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class LightIntensityBinder {#Aspid_MVVM_StarterKit_LightIntensityBinder}
...
[BinderExtensions.BindSafely\<LightIntensityBinder\>\(LightIntensityBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<LightIntensityBinder\>\(LightIntensityBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<LightIntensityBinder\>\(LightIntensityBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### LightIntensityBinder\(\) {#Aspid_MVVM_StarterKit_LightIntensityBinder__ctor}

```csharp
protected LightIntensityBinder()
```
...
### LightIntensityBinder\(Light, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_LightIntensityBinder__ctor_UnityEngine_Light_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_LightIntensityBinder_Property}
