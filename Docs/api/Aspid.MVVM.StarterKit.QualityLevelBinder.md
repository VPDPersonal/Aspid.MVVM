---
title: "Class QualityLevelBinder"
sidebar_label: "QualityLevelBinder"
description: "Class QualityLevelBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class QualityLevelBinder {#Aspid_MVVM_StarterKit_QualityLevelBinder}
...
[BinderExtensions.BindSafely\<QualityLevelBinder\>\(QualityLevelBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<QualityLevelBinder\>\(QualityLevelBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<QualityLevelBinder\>\(QualityLevelBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### QualityLevelBinder\(\) {#Aspid_MVVM_StarterKit_QualityLevelBinder__ctor}

```csharp
protected QualityLevelBinder()
```
...
### QualityLevelBinder\(IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_QualityLevelBinder__ctor_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_QualityLevelBinder_Property}
