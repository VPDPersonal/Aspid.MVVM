---
title: "Class RectTransformAnchorMinBinder"
sidebar_label: "RectTransformAnchorMinBinder"
description: "Class RectTransformAnchorMinBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class RectTransformAnchorMinBinder {#Aspid_MVVM_StarterKit_RectTransformAnchorMinBinder}
...
[BinderExtensions.BindSafely\<RectTransformAnchorMinBinder\>\(RectTransformAnchorMinBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<RectTransformAnchorMinBinder\>\(RectTransformAnchorMinBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<RectTransformAnchorMinBinder\>\(RectTransformAnchorMinBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### RectTransformAnchorMinBinder\(\) {#Aspid_MVVM_StarterKit_RectTransformAnchorMinBinder__ctor}

```csharp
protected RectTransformAnchorMinBinder()
```
...
### RectTransformAnchorMinBinder\(RectTransform, IConverter\<Vector2, Vector2\>, BindMode\) {#Aspid_MVVM_StarterKit_RectTransformAnchorMinBinder__ctor_UnityEngine_RectTransform_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector2_UnityEngine_Vector2__Aspid_MVVM_BindMode_}

```csharp
public RectTransformAnchorMinBinder(RectTransform target, IConverter<Vector2, Vector2> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_RectTransformAnchorMinBinder_Property}
