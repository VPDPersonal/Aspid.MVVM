---
title: "Class RectTransformAnchoredPosition2DCombineConverter"
sidebar_label: "RectTransformAnchoredPosition2DCombineConverter"
description: "Class RectTransformAnchoredPosition2DCombineConverter — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class RectTransformAnchoredPosition2DCombineConverter {#Aspid_MVVM_StarterKit_RectTransformAnchoredPosition2DCombineConverter}
...
```csharp
[Serializable]
[TypeSelectorDisplay(Group = "Aspid/Vector/Combine", Name = "Rect Transform Anchored Position 2D", Tooltip = "Combines a 2D vector with a rect transform's anchored position")]
public sealed class RectTransformAnchoredPosition2DCombineConverter : Vector2CombineConverter, IConverter<Vector2, Vector2>, IConverter<Vector3, Vector2>, IConverter
```
...
### Target {#Aspid_MVVM_StarterKit_RectTransformAnchoredPosition2DCombineConverter_Target}
...
### VectorTo {#Aspid_MVVM_StarterKit_RectTransformAnchoredPosition2DCombineConverter_VectorTo}

Gets the reference vector to combine with, which is the rect transform's
[`anchoredPosition`](https://docs.unity3d.com/ScriptReference/RectTransform-anchoredPosition.html).
