---
title: "Class RectTransformAnchoredPositionCombineConverter"
sidebar_label: "RectTransformAnchoredPositionCombineConverter"
description: "Class RectTransformAnchoredPositionCombineConverter — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class RectTransformAnchoredPositionCombineConverter {#Aspid_MVVM_StarterKit_RectTransformAnchoredPositionCombineConverter}
...
```csharp
[Serializable]
[TypeSelectorDisplay(Group = "Aspid/Vector/Combine", Name = "Rect Transform Anchored Position", Tooltip = "Combines a vector with a rect transform's anchored position")]
public sealed class RectTransformAnchoredPositionCombineConverter : Vector3CombineConverter, IConverter<Vector3, Vector3>, IConverter<Vector2, Vector3>, IConverter
```
...
### Target {#Aspid_MVVM_StarterKit_RectTransformAnchoredPositionCombineConverter_Target}
...
### VectorTo {#Aspid_MVVM_StarterKit_RectTransformAnchoredPositionCombineConverter_VectorTo}

Gets the reference vector to combine with, which is
[`anchoredPosition3D`](https://docs.unity3d.com/ScriptReference/RectTransform-anchoredPosition3D.html) in [`World`](https://docs.unity3d.com/ScriptReference/Space-World.html) or the
two-component [`anchoredPosition`](https://docs.unity3d.com/ScriptReference/RectTransform-anchoredPosition.html) in [`Self`](https://docs.unity3d.com/ScriptReference/Space-Self.html),
...
In [`Self`](https://docs.unity3d.com/ScriptReference/Space-Self.html) the reference vector is widened with a zero Z, so a mode that
