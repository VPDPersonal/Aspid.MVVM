---
title: "Class RectTransformOffsetMaxBinder"
sidebar_label: "RectTransformOffsetMaxBinder"
description: "Class RectTransformOffsetMaxBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class RectTransformOffsetMaxBinder {#Aspid_MVVM_StarterKit_RectTransformOffsetMaxBinder}
...
[BinderExtensions.BindSafely\<RectTransformOffsetMaxBinder\>\(RectTransformOffsetMaxBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<RectTransformOffsetMaxBinder\>\(RectTransformOffsetMaxBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<RectTransformOffsetMaxBinder\>\(RectTransformOffsetMaxBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### RectTransformOffsetMaxBinder\(\) {#Aspid_MVVM_StarterKit_RectTransformOffsetMaxBinder__ctor}

```csharp
protected RectTransformOffsetMaxBinder()
```
...
### RectTransformOffsetMaxBinder\(RectTransform, IConverter\<Vector2, Vector2\>, BindMode\) {#Aspid_MVVM_StarterKit_RectTransformOffsetMaxBinder__ctor_UnityEngine_RectTransform_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector2_UnityEngine_Vector2__Aspid_MVVM_BindMode_}

```csharp
public RectTransformOffsetMaxBinder(RectTransform target, IConverter<Vector2, Vector2> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_RectTransformOffsetMaxBinder_Property}
