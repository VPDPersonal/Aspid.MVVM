---
title: "Class RectTransformOffsetMinBinder"
sidebar_label: "RectTransformOffsetMinBinder"
description: "Class RectTransformOffsetMinBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class RectTransformOffsetMinBinder {#Aspid_MVVM_StarterKit_RectTransformOffsetMinBinder}
...
[BinderExtensions.BindSafely\<RectTransformOffsetMinBinder\>\(RectTransformOffsetMinBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<RectTransformOffsetMinBinder\>\(RectTransformOffsetMinBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<RectTransformOffsetMinBinder\>\(RectTransformOffsetMinBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### RectTransformOffsetMinBinder\(\) {#Aspid_MVVM_StarterKit_RectTransformOffsetMinBinder__ctor}

```csharp
protected RectTransformOffsetMinBinder()
```
...
### RectTransformOffsetMinBinder\(RectTransform, IConverter\<Vector2, Vector2\>, BindMode\) {#Aspid_MVVM_StarterKit_RectTransformOffsetMinBinder__ctor_UnityEngine_RectTransform_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector2_UnityEngine_Vector2__Aspid_MVVM_BindMode_}

```csharp
public RectTransformOffsetMinBinder(RectTransform target, IConverter<Vector2, Vector2> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_RectTransformOffsetMinBinder_Property}
