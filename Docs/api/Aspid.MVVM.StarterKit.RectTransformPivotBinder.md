---
title: "Class RectTransformPivotBinder"
sidebar_label: "RectTransformPivotBinder"
description: "Class RectTransformPivotBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class RectTransformPivotBinder {#Aspid_MVVM_StarterKit_RectTransformPivotBinder}
...
[BinderExtensions.BindSafely\<RectTransformPivotBinder\>\(RectTransformPivotBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<RectTransformPivotBinder\>\(RectTransformPivotBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<RectTransformPivotBinder\>\(RectTransformPivotBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### RectTransformPivotBinder\(\) {#Aspid_MVVM_StarterKit_RectTransformPivotBinder__ctor}

```csharp
protected RectTransformPivotBinder()
```
...
### RectTransformPivotBinder\(RectTransform, IConverter\<Vector2, Vector2\>, BindMode\) {#Aspid_MVVM_StarterKit_RectTransformPivotBinder__ctor_UnityEngine_RectTransform_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector2_UnityEngine_Vector2__Aspid_MVVM_BindMode_}

```csharp
public RectTransformPivotBinder(RectTransform target, IConverter<Vector2, Vector2> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_RectTransformPivotBinder_Property}
