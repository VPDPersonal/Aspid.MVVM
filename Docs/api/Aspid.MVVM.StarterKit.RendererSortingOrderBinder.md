---
title: "Class RendererSortingOrderBinder"
sidebar_label: "RendererSortingOrderBinder"
description: "Class RendererSortingOrderBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class RendererSortingOrderBinder {#Aspid_MVVM_StarterKit_RendererSortingOrderBinder}
...
[TargetBinder\<Renderer, int\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
[TargetIntBinder\<Renderer\>](Aspid.MVVM.StarterKit.TargetIntBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<RendererSortingOrderBinder\>\(RendererSortingOrderBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<RendererSortingOrderBinder\>\(RendererSortingOrderBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<RendererSortingOrderBinder\>\(RendererSortingOrderBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### RendererSortingOrderBinder\(\) {#Aspid_MVVM_StarterKit_RendererSortingOrderBinder__ctor}

```csharp
protected RendererSortingOrderBinder()
```
...
### RendererSortingOrderBinder\(Renderer, IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_RendererSortingOrderBinder__ctor_UnityEngine_Renderer_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}

```csharp
public RendererSortingOrderBinder(Renderer target, IConverter<int, int> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_RendererSortingOrderBinder_Property}
