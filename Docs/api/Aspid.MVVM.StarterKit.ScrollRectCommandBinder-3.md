---
title: "Class ScrollRectCommandBinder<T1, T2, T3>"
sidebar_label: "ScrollRectCommandBinder<T1, T2, T3>"
description: "Class ScrollRectCommandBinder<T1, T2, T3> — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ScrollRectCommandBinder\<T1, T2, T3\> {#Aspid_MVVM_StarterKit_ScrollRectCommandBinder_3}
...
```csharp
[Serializable]
public class ScrollRectCommandBinder<T1, T2, T3> : TargetBinder<ScrollRect>, IRebindableBinder, IBinder<IRelayCommand<Vector2, T1, T2, T3>>, IBinder<IRelayCommand<Vector3, T1, T2, T3>>, IBinder
```
...
[BinderExtensions.BindSafely\<ScrollRectCommandBinder\<T1, T2, T3\>\>\(ScrollRectCommandBinder\<T1, T2, T3\>?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ScrollRectCommandBinder\<T1, T2, T3\>\>\(ScrollRectCommandBinder\<T1, T2, T3\>?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ScrollRectCommandBinder\<T1, T2, T3\>\>\(ScrollRectCommandBinder\<T1, T2, T3\>?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### ScrollRectCommandBinder\(ScrollRect, T1, T2, T3, BindMode\) {#Aspid_MVVM_StarterKit_ScrollRectCommandBinder_3__ctor_UnityEngine_UI_ScrollRect__0__1__2_Aspid_MVVM_BindMode_}

```csharp
public ScrollRectCommandBinder(ScrollRect target, T1 param1, T2 param2, T3 param3, BindMode mode = BindMode.OneWay)
```
...
### ScrollRectCommandBinder\(ScrollRect, T1, T2, T3, ICanExecuteHandler, BindMode\) {#Aspid_MVVM_StarterKit_ScrollRectCommandBinder_3__ctor_UnityEngine_UI_ScrollRect__0__1__2_Aspid_MVVM_StarterKit_ICanExecuteHandler_Aspid_MVVM_BindMode_}

```csharp
public ScrollRectCommandBinder(ScrollRect target, T1 param1, T2 param2, T3 param3, ICanExecuteHandler interactable, BindMode mode = BindMode.OneWay)
```
...
### Param1 {#Aspid_MVVM_StarterKit_ScrollRectCommandBinder_3_Param1}
...
### Param2 {#Aspid_MVVM_StarterKit_ScrollRectCommandBinder_3_Param2}
...
### Param3 {#Aspid_MVVM_StarterKit_ScrollRectCommandBinder_3_Param3}
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_ScrollRectCommandBinder_3_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_ScrollRectCommandBinder_3_OnUnbound}
...
### SetValue\(IRelayCommand\<Vector2, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_ScrollRectCommandBinder_3_SetValue_Aspid_MVVM_IRelayCommand_UnityEngine_Vector2__0__1__2__}
...
### SetValue\(IRelayCommand\<Vector3, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_ScrollRectCommandBinder_3_SetValue_Aspid_MVVM_IRelayCommand_UnityEngine_Vector3__0__1__2__}
