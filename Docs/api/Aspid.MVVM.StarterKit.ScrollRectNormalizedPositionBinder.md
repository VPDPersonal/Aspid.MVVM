---
title: "Class ScrollRectNormalizedPositionBinder"
sidebar_label: "ScrollRectNormalizedPositionBinder"
description: "Class ScrollRectNormalizedPositionBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ScrollRectNormalizedPositionBinder {#Aspid_MVVM_StarterKit_ScrollRectNormalizedPositionBinder}
...
[TargetBinder\<ScrollRect, Vector2\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
...
[BinderExtensions.BindSafely\<ScrollRectNormalizedPositionBinder\>\(ScrollRectNormalizedPositionBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ScrollRectNormalizedPositionBinder\>\(ScrollRectNormalizedPositionBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ScrollRectNormalizedPositionBinder\>\(ScrollRectNormalizedPositionBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### ScrollRectNormalizedPositionBinder\(\) {#Aspid_MVVM_StarterKit_ScrollRectNormalizedPositionBinder__ctor}

```csharp
protected ScrollRectNormalizedPositionBinder()
```
...
### ScrollRectNormalizedPositionBinder\(ScrollRect, IConverter\<Vector2, Vector2\>, BindMode\) {#Aspid_MVVM_StarterKit_ScrollRectNormalizedPositionBinder__ctor_UnityEngine_UI_ScrollRect_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector2_UnityEngine_Vector2__Aspid_MVVM_BindMode_}

```csharp
public ScrollRectNormalizedPositionBinder(ScrollRect target, IConverter<Vector2, Vector2> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_ScrollRectNormalizedPositionBinder_Property}
