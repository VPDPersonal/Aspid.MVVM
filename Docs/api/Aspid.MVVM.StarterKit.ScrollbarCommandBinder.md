---
title: "Class ScrollbarCommandBinder"
sidebar_label: "ScrollbarCommandBinder"
description: "Class ScrollbarCommandBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ScrollbarCommandBinder {#Aspid_MVVM_StarterKit_ScrollbarCommandBinder}
...
```csharp
[Serializable]
public sealed class ScrollbarCommandBinder : TargetBinder<Scrollbar>, IRebindableBinder, IBinder<IRelayCommand<int>>, IBinder<IRelayCommand<long>>, IBinder<IRelayCommand<float>>, IBinder<IRelayCommand<double>>, IBinder
```
...
[BinderExtensions.BindSafely\<ScrollbarCommandBinder\>\(ScrollbarCommandBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ScrollbarCommandBinder\>\(ScrollbarCommandBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ScrollbarCommandBinder\>\(ScrollbarCommandBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### ScrollbarCommandBinder\(Scrollbar, BindMode\) {#Aspid_MVVM_StarterKit_ScrollbarCommandBinder__ctor_UnityEngine_UI_Scrollbar_Aspid_MVVM_BindMode_}
...
### ScrollbarCommandBinder\(Scrollbar, ICanExecuteHandler, BindMode\) {#Aspid_MVVM_StarterKit_ScrollbarCommandBinder__ctor_UnityEngine_UI_Scrollbar_Aspid_MVVM_StarterKit_ICanExecuteHandler_Aspid_MVVM_BindMode_}

```csharp
public ScrollbarCommandBinder(Scrollbar target, ICanExecuteHandler customInteractable, BindMode mode = BindMode.OneWay)
```
...
### ScrollbarCommandBinder\(Scrollbar, InteractableMode, BindMode\) {#Aspid_MVVM_StarterKit_ScrollbarCommandBinder__ctor_UnityEngine_UI_Scrollbar_Aspid_MVVM_StarterKit_InteractableMode_Aspid_MVVM_BindMode_}

```csharp
public ScrollbarCommandBinder(Scrollbar target, InteractableMode interactableMode, BindMode mode = BindMode.OneWay)
```
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_ScrollbarCommandBinder_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_ScrollbarCommandBinder_OnUnbound}
...
### SetValue\(IRelayCommand\<int\>\) {#Aspid_MVVM_StarterKit_ScrollbarCommandBinder_SetValue_Aspid_MVVM_IRelayCommand_System_Int32__}
...
### SetValue\(IRelayCommand\<long\>\) {#Aspid_MVVM_StarterKit_ScrollbarCommandBinder_SetValue_Aspid_MVVM_IRelayCommand_System_Int64__}
...
### SetValue\(IRelayCommand\<float\>\) {#Aspid_MVVM_StarterKit_ScrollbarCommandBinder_SetValue_Aspid_MVVM_IRelayCommand_System_Single__}
...
### SetValue\(IRelayCommand\<double\>\) {#Aspid_MVVM_StarterKit_ScrollbarCommandBinder_SetValue_Aspid_MVVM_IRelayCommand_System_Double__}
