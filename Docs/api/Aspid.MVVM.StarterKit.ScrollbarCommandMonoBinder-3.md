---
title: "Class ScrollbarCommandMonoBinder<T1, T2, T3>"
sidebar_label: "ScrollbarCommandMonoBinder<T1, T2, T3>"
description: "Class ScrollbarCommandMonoBinder<T1, T2, T3> — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ScrollbarCommandMonoBinder\<T1, T2, T3\> {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3}
...
```csharp
public abstract class ScrollbarCommandMonoBinder<T1, T2, T3> : ComponentMonoBinder<Scrollbar>, IMonoBinderValidatable, IRebindableBinder, IBinder<IRelayCommand<int, T1, T2, T3>>, IBinder<IRelayCommand<long, T1, T2, T3>>, IBinder<IRelayCommand<float, T1, T2, T3>>, IBinder<IRelayCommand<double, T1, T2, T3>>, IBinder
```
...
[BinderExtensions.BindSafely\<ScrollbarCommandMonoBinder\<T1, T2, T3\>\>\(ScrollbarCommandMonoBinder\<T1, T2, T3\>?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ScrollbarCommandMonoBinder\<T1, T2, T3\>\>\(ScrollbarCommandMonoBinder\<T1, T2, T3\>?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ScrollbarCommandMonoBinder\<T1, T2, T3\>\>\(ScrollbarCommandMonoBinder\<T1, T2, T3\>?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### SetValueMarker {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_SetValueMarker}
...
### IsDebug {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_IsDebug}
...
### Param1 {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_Param1}
...
### Param2 {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_Param2}
...
### Param3 {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_Param3}
...
### AddLog\(string\) {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_AddLog_System_String_}
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_OnUnbound}
...
### OnValidate\(\) {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_OnValidate}
...
### SetValue\(IRelayCommand\<int, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_SetValue_Aspid_MVVM_IRelayCommand_System_Int32__0__1__2__}
...
### SetValue\(IRelayCommand\<long, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_SetValue_Aspid_MVVM_IRelayCommand_System_Int64__0__1__2__}
...
### SetValue\(IRelayCommand\<float, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_SetValue_Aspid_MVVM_IRelayCommand_System_Single__0__1__2__}
...
### SetValue\(IRelayCommand\<double, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_ScrollbarCommandMonoBinder_3_SetValue_Aspid_MVVM_IRelayCommand_System_Double__0__1__2__}
