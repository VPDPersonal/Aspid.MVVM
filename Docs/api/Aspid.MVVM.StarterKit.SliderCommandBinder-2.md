---
title: "Class SliderCommandBinder<T1, T2>"
sidebar_label: "SliderCommandBinder<T1, T2>"
description: "Class SliderCommandBinder<T1, T2> — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class SliderCommandBinder\<T1, T2\> {#Aspid_MVVM_StarterKit_SliderCommandBinder_2}
...
```csharp
[Serializable]
public class SliderCommandBinder<T1, T2> : TargetBinder<Slider>, IRebindableBinder, IBinder<IRelayCommand<int, T1, T2>>, IBinder<IRelayCommand<long, T1, T2>>, IBinder<IRelayCommand<float, T1, T2>>, IBinder<IRelayCommand<double, T1, T2>>, IBinder
```
...
[BinderExtensions.BindSafely\<SliderCommandBinder\<T1, T2\>\>\(SliderCommandBinder\<T1, T2\>?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<SliderCommandBinder\<T1, T2\>\>\(SliderCommandBinder\<T1, T2\>?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<SliderCommandBinder\<T1, T2\>\>\(SliderCommandBinder\<T1, T2\>?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### SliderCommandBinder\(Slider, T1, T2, BindMode\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_2__ctor_UnityEngine_UI_Slider__0__1_Aspid_MVVM_BindMode_}
...
### SliderCommandBinder\(Slider, T1, T2, ICanExecuteHandler, BindMode\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_2__ctor_UnityEngine_UI_Slider__0__1_Aspid_MVVM_StarterKit_ICanExecuteHandler_Aspid_MVVM_BindMode_}
...
### SliderCommandBinder\(Slider, T1, T2, InteractableMode, BindMode\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_2__ctor_UnityEngine_UI_Slider__0__1_Aspid_MVVM_StarterKit_InteractableMode_Aspid_MVVM_BindMode_}
...
### Param1 {#Aspid_MVVM_StarterKit_SliderCommandBinder_2_Param1}
...
### Param2 {#Aspid_MVVM_StarterKit_SliderCommandBinder_2_Param2}
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_2_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_2_OnUnbound}
...
### SetValue\(IRelayCommand\<int, T1, T2\>\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_2_SetValue_Aspid_MVVM_IRelayCommand_System_Int32__0__1__}
...
### SetValue\(IRelayCommand\<long, T1, T2\>\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_2_SetValue_Aspid_MVVM_IRelayCommand_System_Int64__0__1__}
...
### SetValue\(IRelayCommand\<float, T1, T2\>\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_2_SetValue_Aspid_MVVM_IRelayCommand_System_Single__0__1__}
...
### SetValue\(IRelayCommand\<double, T1, T2\>\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_2_SetValue_Aspid_MVVM_IRelayCommand_System_Double__0__1__}
