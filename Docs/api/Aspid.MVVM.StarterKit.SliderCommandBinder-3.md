---
title: "Class SliderCommandBinder<T1, T2, T3>"
sidebar_label: "SliderCommandBinder<T1, T2, T3>"
description: "Class SliderCommandBinder<T1, T2, T3> — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class SliderCommandBinder\<T1, T2, T3\> {#Aspid_MVVM_StarterKit_SliderCommandBinder_3}
...
```csharp
[Serializable]
public class SliderCommandBinder<T1, T2, T3> : TargetBinder<Slider>, IRebindableBinder, IBinder<IRelayCommand<int, T1, T2, T3>>, IBinder<IRelayCommand<long, T1, T2, T3>>, IBinder<IRelayCommand<float, T1, T2, T3>>, IBinder<IRelayCommand<double, T1, T2, T3>>, IBinder
```
...
[BinderExtensions.BindSafely\<SliderCommandBinder\<T1, T2, T3\>\>\(SliderCommandBinder\<T1, T2, T3\>?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<SliderCommandBinder\<T1, T2, T3\>\>\(SliderCommandBinder\<T1, T2, T3\>?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<SliderCommandBinder\<T1, T2, T3\>\>\(SliderCommandBinder\<T1, T2, T3\>?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### SliderCommandBinder\(Slider, T1, T2, T3, BindMode\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_3__ctor_UnityEngine_UI_Slider__0__1__2_Aspid_MVVM_BindMode_}
...
### SliderCommandBinder\(Slider, T1, T2, T3, ICanExecuteHandler, BindMode\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_3__ctor_UnityEngine_UI_Slider__0__1__2_Aspid_MVVM_StarterKit_ICanExecuteHandler_Aspid_MVVM_BindMode_}
...
### SliderCommandBinder\(Slider, T1, T2, T3, InteractableMode, BindMode\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_3__ctor_UnityEngine_UI_Slider__0__1__2_Aspid_MVVM_StarterKit_InteractableMode_Aspid_MVVM_BindMode_}
...
### Param1 {#Aspid_MVVM_StarterKit_SliderCommandBinder_3_Param1}
...
### Param2 {#Aspid_MVVM_StarterKit_SliderCommandBinder_3_Param2}
...
### Param3 {#Aspid_MVVM_StarterKit_SliderCommandBinder_3_Param3}
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_3_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_3_OnUnbound}
...
### SetValue\(IRelayCommand\<int, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_3_SetValue_Aspid_MVVM_IRelayCommand_System_Int32__0__1__2__}
...
### SetValue\(IRelayCommand\<long, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_3_SetValue_Aspid_MVVM_IRelayCommand_System_Int64__0__1__2__}
...
### SetValue\(IRelayCommand\<float, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_3_SetValue_Aspid_MVVM_IRelayCommand_System_Single__0__1__2__}
...
### SetValue\(IRelayCommand\<double, T1, T2, T3\>\) {#Aspid_MVVM_StarterKit_SliderCommandBinder_3_SetValue_Aspid_MVVM_IRelayCommand_System_Double__0__1__2__}
