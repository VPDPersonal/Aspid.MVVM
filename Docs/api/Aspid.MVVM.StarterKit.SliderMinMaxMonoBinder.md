---
title: "Class SliderMinMaxMonoBinder"
sidebar_label: "SliderMinMaxMonoBinder"
description: "Class SliderMinMaxMonoBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class SliderMinMaxMonoBinder {#Aspid_MVVM_StarterKit_SliderMinMaxMonoBinder}
...
[ComponentMonoBinder\<Slider, Vector2\>](Aspid.MVVM.StarterKit.ComponentMonoBinder-2.md) ← 
...
[BinderExtensions.BindSafely\<SliderMinMaxMonoBinder\>\(SliderMinMaxMonoBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<SliderMinMaxMonoBinder\>\(SliderMinMaxMonoBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<SliderMinMaxMonoBinder\>\(SliderMinMaxMonoBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Remarks

See [`SliderExtensions.SetMinMax`](Aspid.MVVM.StarterKit.SliderExtensions.md) for how the range is validated.

## Properties

### Property {#Aspid_MVVM_StarterKit_SliderMinMaxMonoBinder_Property}
