---
title: "Class SphereColliderCenterBinder"
sidebar_label: "SphereColliderCenterBinder"
description: "Class SphereColliderCenterBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class SphereColliderCenterBinder {#Aspid_MVVM_StarterKit_SphereColliderCenterBinder}
...
[TargetBinder\<SphereCollider, Vector3\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
...
[BinderExtensions.BindSafely\<SphereColliderCenterBinder\>\(SphereColliderCenterBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<SphereColliderCenterBinder\>\(SphereColliderCenterBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<SphereColliderCenterBinder\>\(SphereColliderCenterBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### SphereColliderCenterBinder\(\) {#Aspid_MVVM_StarterKit_SphereColliderCenterBinder__ctor}

```csharp
protected SphereColliderCenterBinder()
```
...
### SphereColliderCenterBinder\(SphereCollider, IConverter\<Vector3, Vector3\>, BindMode\) {#Aspid_MVVM_StarterKit_SphereColliderCenterBinder__ctor_UnityEngine_SphereCollider_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector3_UnityEngine_Vector3__Aspid_MVVM_BindMode_}

```csharp
public SphereColliderCenterBinder(SphereCollider target, IConverter<Vector3, Vector3> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_SphereColliderCenterBinder_Property}
