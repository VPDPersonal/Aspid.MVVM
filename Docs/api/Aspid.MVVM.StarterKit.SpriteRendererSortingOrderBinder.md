---
title: "Class SpriteRendererSortingOrderBinder"
sidebar_label: "SpriteRendererSortingOrderBinder"
description: "Class SpriteRendererSortingOrderBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class SpriteRendererSortingOrderBinder {#Aspid_MVVM_StarterKit_SpriteRendererSortingOrderBinder}
...
[TargetBinder\<SpriteRenderer, int\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
[TargetIntBinder\<SpriteRenderer\>](Aspid.MVVM.StarterKit.TargetIntBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<SpriteRendererSortingOrderBinder\>\(SpriteRendererSortingOrderBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<SpriteRendererSortingOrderBinder\>\(SpriteRendererSortingOrderBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<SpriteRendererSortingOrderBinder\>\(SpriteRendererSortingOrderBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### SpriteRendererSortingOrderBinder\(\) {#Aspid_MVVM_StarterKit_SpriteRendererSortingOrderBinder__ctor}

```csharp
protected SpriteRendererSortingOrderBinder()
```
...
### SpriteRendererSortingOrderBinder\(SpriteRenderer, IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_SpriteRendererSortingOrderBinder__ctor_UnityEngine_SpriteRenderer_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}

```csharp
public SpriteRendererSortingOrderBinder(SpriteRenderer target, IConverter<int, int> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_SpriteRendererSortingOrderBinder_Property}
