---
title: "Class TargetFloatBinder<TTarget>"
sidebar_label: "TargetFloatBinder<TTarget>"
description: "Class TargetFloatBinder<TTarget> — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class TargetFloatBinder\<TTarget\> {#Aspid_MVVM_StarterKit_TargetFloatBinder_1}
...
```csharp
[Serializable]
public abstract class TargetFloatBinder<TTarget> : TargetBinder<TTarget, float>, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, INumberReverseBinder, IReverseBinder<int>, IReverseBinder<long>, IReverseBinder<float>, IReverseBinder<double>, IBinder
```
...
[TargetBinder\<TTarget, float\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
...
[BinderExtensions.BindSafely\<TargetFloatBinder\<TTarget\>\>\(TargetFloatBinder\<TTarget\>?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<TargetFloatBinder\<TTarget\>\>\(TargetFloatBinder\<TTarget\>?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<TargetFloatBinder\<TTarget\>\>\(TargetFloatBinder\<TTarget\>?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Constructors

### TargetFloatBinder\(\) {#Aspid_MVVM_StarterKit_TargetFloatBinder_1__ctor}
...
### TargetFloatBinder\(TTarget, IConverter\<float, float\>?, BindMode\) {#Aspid_MVVM_StarterKit_TargetFloatBinder_1__ctor__0_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### SendInitialValueToSource\(\) {#Aspid_MVVM_StarterKit_TargetFloatBinder_1_SendInitialValueToSource}
