---
title: "Class TextFontSizeBinder"
sidebar_label: "TextFontSizeBinder"
description: "Class TextFontSizeBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class TextFontSizeBinder {#Aspid_MVVM_StarterKit_TextFontSizeBinder}
...
```csharp
[Serializable]
public class TextFontSizeBinder : TargetFloatBinder<TMP_Text>, IRebindableBinder, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, INumberReverseBinder, IReverseBinder<int>, IReverseBinder<long>, IReverseBinder<float>, IReverseBinder<double>, IBinder
```
...
[BinderExtensions.BindSafely\<TextFontSizeBinder\>\(TextFontSizeBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<TextFontSizeBinder\>\(TextFontSizeBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<TextFontSizeBinder\>\(TextFontSizeBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### TextFontSizeBinder\(\) {#Aspid_MVVM_StarterKit_TextFontSizeBinder__ctor}

```csharp
protected TextFontSizeBinder()
```
...
### TextFontSizeBinder\(TMP\_Text, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_TextFontSizeBinder__ctor_TMPro_TMP_Text_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_TextFontSizeBinder_Property}
