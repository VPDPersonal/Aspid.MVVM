---
title: "Class TextFontSizeSwitcherBinder"
sidebar_label: "TextFontSizeSwitcherBinder"
description: "Class TextFontSizeSwitcherBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class TextFontSizeSwitcherBinder {#Aspid_MVVM_StarterKit_TextFontSizeSwitcherBinder}
...
```csharp
[Serializable]
public sealed class TextFontSizeSwitcherBinder : SwitcherBinder<TMP_Text, float>, IRebindableBinder, IBinder<bool>, IBinder
```
...
[SwitcherBinder\<TMP\_Text, float\>](Aspid.MVVM.StarterKit.SwitcherBinder-2.md) ← 
...
[BinderExtensions.BindSafely\<TextFontSizeSwitcherBinder\>\(TextFontSizeSwitcherBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<TextFontSizeSwitcherBinder\>\(TextFontSizeSwitcherBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<TextFontSizeSwitcherBinder\>\(TextFontSizeSwitcherBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### TextFontSizeSwitcherBinder\(TMP\_Text, float, float, IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_TextFontSizeSwitcherBinder__ctor_TMPro_TMP_Text_System_Single_System_Single_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}

```csharp
public TextFontSizeSwitcherBinder(TMP_Text target, float trueValue, float falseValue, IConverter<float, float> converter = null, BindMode mode = BindMode.OneWay)
```
...
### SetValue\(float\) {#Aspid_MVVM_StarterKit_TextFontSizeSwitcherBinder_SetValue_System_Single_}
