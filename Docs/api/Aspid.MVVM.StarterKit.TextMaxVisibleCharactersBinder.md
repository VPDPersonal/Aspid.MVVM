---
title: "Class TextMaxVisibleCharactersBinder"
sidebar_label: "TextMaxVisibleCharactersBinder"
description: "Class TextMaxVisibleCharactersBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class TextMaxVisibleCharactersBinder {#Aspid_MVVM_StarterKit_TextMaxVisibleCharactersBinder}
...
[TargetBinder\<TMP\_Text, int\>](Aspid.MVVM.StarterKit.TargetBinder-2.md) ← 
[TargetIntBinder\<TMP\_Text\>](Aspid.MVVM.StarterKit.TargetIntBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<TextMaxVisibleCharactersBinder\>\(TextMaxVisibleCharactersBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<TextMaxVisibleCharactersBinder\>\(TextMaxVisibleCharactersBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<TextMaxVisibleCharactersBinder\>\(TextMaxVisibleCharactersBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Remarks

<code>0</code> hides the text without clearing it.

## Constructors

### TextMaxVisibleCharactersBinder\(\) {#Aspid_MVVM_StarterKit_TextMaxVisibleCharactersBinder__ctor}

```csharp
protected TextMaxVisibleCharactersBinder()
```
...
### TextMaxVisibleCharactersBinder\(TMP\_Text, IConverter\<int, int\>, BindMode\) {#Aspid_MVVM_StarterKit_TextMaxVisibleCharactersBinder__ctor_TMPro_TMP_Text_Aspid_MVVM_StarterKit_IConverter_System_Int32_System_Int32__Aspid_MVVM_BindMode_}

```csharp
public TextMaxVisibleCharactersBinder(TMP_Text target, IConverter<int, int> converter = null, BindMode mode = BindMode.OneWay)
```
...
### Property {#Aspid_MVVM_StarterKit_TextMaxVisibleCharactersBinder_Property}
