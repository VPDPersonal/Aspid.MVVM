---
title: "Class TimeScaleBinder"
sidebar_label: "TimeScaleBinder"
description: "Class TimeScaleBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class TimeScaleBinder {#Aspid_MVVM_StarterKit_TimeScaleBinder}
...
[BinderExtensions.BindSafely\<TimeScaleBinder\>\(TimeScaleBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<TimeScaleBinder\>\(TimeScaleBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<TimeScaleBinder\>\(TimeScaleBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### TimeScaleBinder\(\) {#Aspid_MVVM_StarterKit_TimeScaleBinder__ctor}

```csharp
protected TimeScaleBinder()
```
...
### TimeScaleBinder\(IConverter\<float, float\>, BindMode\) {#Aspid_MVVM_StarterKit_TimeScaleBinder__ctor_Aspid_MVVM_StarterKit_IConverter_System_Single_System_Single__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_TimeScaleBinder_Property}
