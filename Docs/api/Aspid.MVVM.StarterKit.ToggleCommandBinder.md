---
title: "Class ToggleCommandBinder"
sidebar_label: "ToggleCommandBinder"
description: "Class ToggleCommandBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class ToggleCommandBinder {#Aspid_MVVM_StarterKit_ToggleCommandBinder}
...
```csharp
[Serializable]
public sealed class ToggleCommandBinder : TargetBinder<Toggle>, IRebindableBinder, IBinder<IRelayCommand>, IBinder<IRelayCommand<bool>>, IBinder
```
...
[BinderExtensions.BindSafely\<ToggleCommandBinder\>\(ToggleCommandBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<ToggleCommandBinder\>\(ToggleCommandBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<ToggleCommandBinder\>\(ToggleCommandBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### ToggleCommandBinder\(Toggle, BindMode\) {#Aspid_MVVM_StarterKit_ToggleCommandBinder__ctor_UnityEngine_UI_Toggle_Aspid_MVVM_BindMode_}
...
### ToggleCommandBinder\(Toggle, ICanExecuteHandler, BindMode\) {#Aspid_MVVM_StarterKit_ToggleCommandBinder__ctor_UnityEngine_UI_Toggle_Aspid_MVVM_StarterKit_ICanExecuteHandler_Aspid_MVVM_BindMode_}

```csharp
public ToggleCommandBinder(Toggle target, ICanExecuteHandler customInteractable, BindMode mode = BindMode.OneWay)
```
...
### ToggleCommandBinder\(Toggle, InteractableMode, BindMode\) {#Aspid_MVVM_StarterKit_ToggleCommandBinder__ctor_UnityEngine_UI_Toggle_Aspid_MVVM_StarterKit_InteractableMode_Aspid_MVVM_BindMode_}
...
### OnBound\(\) {#Aspid_MVVM_StarterKit_ToggleCommandBinder_OnBound}
...
### OnUnbound\(\) {#Aspid_MVVM_StarterKit_ToggleCommandBinder_OnUnbound}
...
### SetValue\(IRelayCommand\) {#Aspid_MVVM_StarterKit_ToggleCommandBinder_SetValue_Aspid_MVVM_IRelayCommand_}
...
### SetValue\(IRelayCommand\<bool\>\) {#Aspid_MVVM_StarterKit_ToggleCommandBinder_SetValue_Aspid_MVVM_IRelayCommand_System_Boolean__}
