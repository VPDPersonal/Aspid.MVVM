---
title: "Class TransformScaleBinder"
sidebar_label: "TransformScaleBinder"
description: "Class TransformScaleBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class TransformScaleBinder {#Aspid_MVVM_StarterKit_TransformScaleBinder}
...
[BinderExtensions.BindSafely\<TransformScaleBinder\>\(TransformScaleBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<TransformScaleBinder\>\(TransformScaleBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<TransformScaleBinder\>\(TransformScaleBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)
...
### TransformScaleBinder\(\) {#Aspid_MVVM_StarterKit_TransformScaleBinder__ctor}

```csharp
protected TransformScaleBinder()
```
...
### TransformScaleBinder\(Transform, IConverter\<Vector3, Vector3\>, BindMode\) {#Aspid_MVVM_StarterKit_TransformScaleBinder__ctor_UnityEngine_Transform_Aspid_MVVM_StarterKit_IConverter_UnityEngine_Vector3_UnityEngine_Vector3__Aspid_MVVM_BindMode_}
...
### Property {#Aspid_MVVM_StarterKit_TransformScaleBinder_Property}
...
### SetValue\(float\) {#Aspid_MVVM_StarterKit_TransformScaleBinder_SetValue_System_Single_}
