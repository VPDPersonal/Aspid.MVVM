---
title: "Class TweenVector3MonoBinder"
sidebar_label: "TweenVector3MonoBinder"
description: "Class TweenVector3MonoBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class TweenVector3MonoBinder {#Aspid_MVVM_StarterKit_TweenVector3MonoBinder}
...
[TweenMonoBinder\<Vector3\>](Aspid.MVVM.StarterKit.TweenMonoBinder-1.md) ← 
...
[BinderExtensions.BindSafely\<TweenVector3MonoBinder\>\(TweenVector3MonoBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<TweenVector3MonoBinder\>\(TweenVector3MonoBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<TweenVector3MonoBinder\>\(TweenVector3MonoBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Methods

### Interpolate\(Vector3, Vector3, float\) {#Aspid_MVVM_StarterKit_TweenVector3MonoBinder_Interpolate_UnityEngine_Vector3_UnityEngine_Vector3_System_Single_}

Interpolates between <code class="paramref">from</code> and <code class="paramref">to</code>.
...
The value to forward this frame.
