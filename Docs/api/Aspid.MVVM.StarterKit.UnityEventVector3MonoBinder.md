---
title: "Class UnityEventVector3MonoBinder"
sidebar_label: "UnityEventVector3MonoBinder"
description: "Class UnityEventVector3MonoBinder — Aspid.MVVM API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class UnityEventVector3MonoBinder {#Aspid_MVVM_StarterKit_UnityEventVector3MonoBinder}
...
[AddBinderContextMenu(typeof(Component), new string[] { }, Path = "Add General Binder/UnityEvent/UnityEvent Binder – Vector3")]
public sealed class UnityEventVector3MonoBinder : MonoBinder, IMonoBinderValidatable, IRebindableBinder, IVector3Binder, IVectorBinder, IBinder<Vector2>, IBinder<Vector3>, IFloatBinder, INumberBinder, IBinder<int>, IBinder<uint>, IBinder<long>, IBinder<ulong>, IBinder<byte>, IBinder<sbyte>, IBinder<short>, IBinder<ushort>, IBinder<float>, IBinder<double>, IBinder
```
...
[BinderExtensions.BindSafely\<UnityEventVector3MonoBinder\>\(UnityEventVector3MonoBinder?, in FindBindableMemberResult, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_FindBindableMemberResult__System_Object_System_String_), 
[BinderExtensions.BindSafely\<UnityEventVector3MonoBinder\>\(UnityEventVector3MonoBinder?, IBinderAdder, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_BindSafely__1___0_Aspid_MVVM_IBinderAdder_System_Object_System_String_), 
...
[BinderExtensions.UnbindSafely\<UnityEventVector3MonoBinder\>\(UnityEventVector3MonoBinder?, object?, string?\)](Aspid.MVVM.BinderExtensions.md#Aspid_MVVM_BinderExtensions_UnbindSafely__1___0_System_Object_System_String_)

## Methods

### SetValue\(Vector3\) {#Aspid_MVVM_StarterKit_UnityEventVector3MonoBinder_SetValue_UnityEngine_Vector3_}
