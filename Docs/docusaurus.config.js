      ...
      ({
        ...
        docs: {
          ...
          sidebarItemsGenerator: async ({ defaultSidebarItemsGenerator, ...args }) => {
            ...
            // The StarterKit category takes its label from the index doc's title; keep the sidebar short.
            for (const item of items) {
              if (item.type === 'category' && item.link?.type === 'doc' && item.link.id === 'StarterKit/README') item.label = 'StarterKit';
            }
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              { label: 'API Reference', to: '/api/Aspid.MVVM' },
