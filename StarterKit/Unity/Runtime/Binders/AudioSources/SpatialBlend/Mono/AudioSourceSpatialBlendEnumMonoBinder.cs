...
{
    /// <summary>
    /// <see cref="EnumFloatMonoBinder{AudioSource}"/> that sets the <see cref="AudioSource.spatialBlend"/>
    ...
    public sealed class AudioSourceSpatialBlendEnumMonoBinder : EnumFloatMonoBinder<AudioSource>
    {
        /// <summary>
